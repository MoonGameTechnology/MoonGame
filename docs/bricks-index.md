...
| PHONE-STRATEGY | ✅ |  | `docs/backlog.md:14918` | Технологии, постройки, производство, рынок и дипломатия |
| MAP-PERF | ✅ |  | `docs/backlog.md:14930` | Ускорение движения раскрытой голографической карты и подготовка |
...
| PVR-0.1 | ✅ | data | `docs/sector-zero-roadmap.md:809` | Карта pve-1 снова строится |
| PVR-0.2 | ✅ | proto | `docs/sector-zero-roadmap.md:839` | pveModule в ядре прототипа |
| PVR-0.3 | ⏳ | proto | `docs/sector-zero-roadmap.md:866` | Сохранение: сперва мета, потом забег |
| PVR-1.1 | ✅ | proto core data cli | `docs/sector-zero-roadmap.md:887` | Соло-запуск задаёт modeId |
| PVR-1.2 | ⏳ | proto | `docs/sector-zero-roadmap.md:929` | HUD забега: волна N из M и время до следующей |
| PVR-1.3 | ⏳ | data | `docs/sector-zero-roadmap.md:935` | Состав волны перестаёт быть одним дроном |
| PVR-1.4 | 🔒 | proto | `docs/sector-zero-roadmap.md:943` | Выбор между волнами |
| PVR-2.1 | ⏳ | proto | `docs/sector-zero-roadmap.md:954` | Выбор сложности на запуске забега |
| PVR-3.1 | ⏳ | docs | `docs/sector-zero-roadmap.md:965` | Резолюция: чем PvE-прокачка НЕ является |
| PVR-3.2 | 🔒 | proto | `docs/sector-zero-roadmap.md:973` | Хранилище PvE-прогресса |
| PVR-3.3 | 🔒 | proto | `docs/sector-zero-roadmap.md:980` | Награда за забег |
| PVR-4.1 | ⏳ | docs | `docs/sector-zero-roadmap.md:994` | Резолюция: что из §3 входит в первую версию |
| PVR-4.2 | 🔒 | core | `docs/sector-zero-roadmap.md:1002` | Память Роя как состояние |
| PVR-4.3 | 🔒 | core data | `docs/sector-zero-roadmap.md:1011` | Одна читаемая адаптация от сигнала до формы |
| PVR-4.4 | 🔒 | data | `docs/sector-zero-roadmap.md:1019` | Структуры первого набора |
| PVR-4.5 | 🔒 | proto | `docs/sector-zero-roadmap.md:1025` | Журнал адаптаций |
