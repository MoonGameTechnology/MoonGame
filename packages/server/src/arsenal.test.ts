...
describe('достижимость содержимого на гейтированном месте', () => {
   ...
   *  и мимо же идёт ВЫДАВАЕМОЕ (`issued`) — отряд, который приходит вместе со своим
   *  сооружением и в меновой экономике арсенала не участвует вовсе: его не открывают, не
   *  роняют в дропе и не выставляют на место. Первый такой — орудия крепости (FORT-5.4).
   *  Это не исключение из правила «мёртвого контента быть не должно», а уточнение, кого
