...
describe('дополнительные задачи карты (PVR-5.2)', () => {
  ...
  it('в первой главе восемь задач со спасением учёного, во второй — семь', () => {
    // Владелец добавил сюжетное спасение учёного к семи дополнительным задачам главы I.
    expect(pveObjectives(0)).toHaveLength(8);
