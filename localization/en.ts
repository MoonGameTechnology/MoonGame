...
export const en: Record<string, string> = {
  ...
  'controls.add.does': 'Add the fleet to the selection',
  'controls.add.keys': 'Ctrl or Shift + click a fleet',
  'controls.back.does': 'Back: close the top window',
  'controls.back.keys': 'Esc',
  'controls.box.does': 'Box-select fleets (from empty space)',
  'controls.box.keys': 'Shift + drag',
  'controls.dblclick.does': 'Default view',
  'controls.dblclick.keys': 'Double-click the map',
  'controls.double-tap.keys': 'Double-tap the map',
  'controls.drag.does': 'Pan the map',
  'controls.drag.keys': 'Left-drag',
  'controls.long-press.does': 'On your fleet — add to or remove from the selection; on empty space — box select',
  'controls.long-press.keys': 'Long press',
  'controls.pinch.does': 'Zoom',
  'controls.pinch.keys': 'Two-finger pinch',
  'controls.quick-build.does': 'Order without the confirmation window',
  'controls.quick-build.keys': 'Right-click a build tile',
  ...
  'hud.missions.label': 'Objectives',
  'hud.missions.title': 'Run objectives',
  'hud.missions.hint': 'Research data and warrants are paid at the end of the expedition.',
  'hud.missions.failed': 'failed',
  'hud.missions.show': 'Show',
  'mission.rescue-scientist': 'Rescue the scientist: bring a ship to the research station',
  'hud.missions.recruit-reward': 'The hero ship joins immediately upon rescue.',
  'mission.claim-colony': 'Second colony: take the neighbouring world',
  'mission.destroy-hive': 'Destroy the hive: take it by assault',
  'mission.pirate-den': "Destroy the pirates' den: take it by assault",
  ...
  'mission.beachhead': 'Beachhead: take the Swarm forward beachhead',
  'mission.fort-east': 'Fort: build a fort at the eastern colony',
  'mission.starfort-west': 'Fortress: build a star fortress at the western colony',
  'mission.watch-post': 'Watch post: take the western post',
  'mission.retake-station': 'Quarantine station: retake the central station',
  'mission.training-beacon': 'Training beacon: take the observation station',
  'mission.training-recon': 'Recon: identify the whole range — {n} provinces',
  ...
  'battle.win.role.attacker': '⚔ attacking',
  'battle.win.role.defender': '🛡 defending',
  'battle.win.rule': 'One round per hour: the sides trade volleys. A side drops out when it runs out of forces or retreats; the cap is 240 rounds.',
  'battle.win.rule.run': 'One round every {n} s: the sides trade volleys. A side drops out when it runs out of forces or retreats; the cap is 240 rounds.',
  'battle.win.veteran': 'Service: +{n}% damage from battles survived',
  'battle.win.veteran-both': 'Service: +{n}% damage and +{h}% toughness from battles survived',
  'battle.win.veteran-hull': 'Service: +{h}% toughness from battles survived',
  'battle.win.tone.hurt': 'battered',
  'battle.win.tone.low': 'critical',
  'battle.win.tone.ok': 'intact',
  'battle.win.you': 'you',
  ...
  'shipcard.codex': 'Hull reference',
  'shipcard.empty': 'empty',
  'shipcard.extra': 'over capacity',
  'shipcard.loadout': 'Loadout · {n}/{m}',
  'shipcard.loadout.none': 'This hull has no module bays',
  'shipcard.stars': 'Stars: {n}',
  'shipcard.stat.pd': 'Point defence',
  'shipcard.stats': 'One ship: bare hull → fitted',
  ...
  'build.lander.troop': 'Trooper aboard',
  'build.cat.all': 'ALL',
  ...
  "data.swarm-relay": "Swarm Major Relay",
  "data.swarm-relay-small": "Swarm Minor Relay",
  ...
  'swarm.intel.live': 'On radar',
  'swarm.intel.stale': 'Out of sight — composition may have changed',
  'swarm.intel.stale.short': 'Seen earlier',
  // Dossier docked right and collapsible (owner's order 2026-09-23): the summary stays visible when folded.
  'swarm.intel.badge': 'Forces seen: {seen} · on radar: {live}',
  'swarm.intel.badge.none': 'No Swarm forces seen yet',
  'swarm.intel.forces': 'Forces seen',
  'swarm.intel.jump': 'Show on map',
  'swarm.intel.about': 'About the Swarm',
  'swarm.intel.fold': 'Collapse dossier',
  ...
  'run.abandon.lost.title': 'Fleet lost',
  'run.abandon.lost.text': 'No ships left. Rebuild at the shipyard or end the expedition: rewards for waves, objectives and enemies destroyed, as for a defeat.',
  'run.abandon.ask.title': 'End the expedition?',
  'run.abandon.ask.text': 'The expedition ends in defeat right away. Rewards: waves, objectives and enemies destroyed.',
  'run.abandon.rebuild': 'Rebuild',
  'run.abandon.back': 'Continue',
  'run.abandon.go': 'End expedition',
  'run.exit.title': 'Leave the expedition?',
  'run.exit.text': 'To menu — the expedition is saved and continues where you left off. End — a defeat; rewards for waves, objectives and enemies destroyed.',
  'run.exit.double': 'On the results screen it can be doubled for an ad.',
  'run.exit.reward': 'You take now: +{n} data, +{w} ⌖',
  'run.exit.menu': 'To menu',
  'run.exit.go': 'End and collect the reward',
  ...
  'cmd.retreat.hint': 'Falls back to your selected world, else the capital',
  'cmd.retreat.off': 'Off',
  'cmd.retreat.title': 'Retreat when hull drops below:',
  'cmd.selection.many': '{n} FLEETS',
  'cmd.selection.one': 'FLEET',
  'cmd.split': 'Split',
  'cmd.split.hint': 'peel some ships off into a new fleet — docked or under way',
  ...
  'data.training-range': 'Training Range',
  ...
  'data.training-opposition': 'Training opposition',
  ...
  'dossier.tab.ground.desc': 'Load them onto a fleet to capture enemy worlds.',
  'dossier.tab.ground.name': 'Ground',
  'dossier.tab.ships.desc': 'Fleets in orbit and the ship order queue.',
  ...
  'province.pve-1.research-station': 'Research Station',
  'province.pve-1.pirate-den': "Pirates' Den",
  'province.pve-1.home-a': 'Dawn Outpost',
  'province.pve-1.home-b': 'Echo Colony',
  'province.pve-1.drift': 'Stone Drift',
  'province.pve-1.veil': 'Grey Veil',
  'province.pve-1.cluster': 'Ore Cluster',
  'province.pve-1.shoal': 'Beacon Shoal',
  'province.pve-1.shear': 'Ion Shear',
  'province.pve-1.ridge': 'Storm Ridge',
  'province.pve-1.hive': 'Ash Hive',
  'province.pve-1.ford': 'Star Ford',
  'province.pve-1.cove': 'Murk Cove',
  'province.pve-2.landing': 'Beachhead',
  'province.pve-2.rim-veil': 'Rim Veil',
  'province.pve-2.cold-shoal': 'Cold Shoal',
  'province.pve-2.dig-site': 'Dig Site',
  'province.pve-2.wreck-spine': 'Wreck Spine',
  'province.pve-2.flare-belt': 'Flare Belt',
  'province.pve-2.rockfield': 'Rockfield',
  'province.pve-2.dust-reach': 'Dust Reach',
  'province.pve-2.ore-knot': 'Ore Knot',
  'province.pve-2.ion-wall': 'Ion Wall',
  'province.pve-2.hollow': 'Quiet Hollow',
  'province.pve-2.wreck-tail': 'Wreck Tail',
  'province.pve-2.camp': 'Abandoned Camp',
  'province.pve-2.relay': 'Relay Station',
  'province.pve-2.drift-moon': 'Drift Moon',
  'province.pve-2.spore-cloud': 'Spore Cloud',
  'province.pve-2.scree': 'Scree',
  'province.pve-2.deep-drift': 'Deep Drift',
  'province.pve-2.veil-deep': 'Deep Veil',
  'province.pve-2.biopit': 'Bio Pit',
  'province.pve-2.brood-yard': 'Brood Yard',
  'province.pve-2.nest': 'The Nest',
  'province.pve-2.salvage-pocket': 'Salvage Pocket',
  'province.pve-2.bone-drift': 'Bone Drift',
  'province.pve-3.bastion': 'Cordon Bastion',
  'province.pve-3.west-colony': 'West Colony',
  'province.pve-3.east-colony': 'East Colony',
  'province.pve-3.north-reach': 'North Reach',
  'province.pve-3.gate-yard': 'Gate Yard',
  'province.pve-3.ore-shelf': 'Ore Shelf',
  'province.pve-3.hinter-veil': 'Hinter Veil',
  'province.pve-3.watch-post': 'Watch Post',
  'province.pve-3.north-gate': 'North Gate',
  'province.pve-3.east-haze': 'East Haze',
  'province.pve-3.front-w': 'West Front',
  'province.pve-3.front-e': 'East Front',
  'province.pve-3.rift-far-w': 'Abyss Rift',
  'province.pve-3.west-pass': 'West Pass',
  'province.pve-3.rift-w': 'Wedge Rift',
  'province.pve-3.quarantine': 'Quarantine Zone',
  'province.pve-3.rift-e': 'Seam Rift',
  'province.pve-3.east-pass': 'East Pass',
  'province.pve-3.rift-far-e': 'Maw Rift',
  'province.pve-3.south-west': 'Southwest Reef',
  'province.pve-3.beachhead': 'Swarm Beachhead',
  'province.pve-3.spore-reach': 'Spore Reach',
  'province.pve-3.wreck-w': 'Ship Graveyard',
  'province.pve-3.storm-e': 'East Storm',
  'province.pve-3.biofarm-w': 'West Biofarm',
  'province.pve-3.biofarm-e': 'East Biofarm',
  'province.pve-3.beacon-rock': 'Beacon Rock',
  'province.pve-3.hive': 'Plague Hive',
  'province.duel-testbed.home-a': 'Belt Capital',
  'province.duel-testbed.belt-n': 'Northern Ridge',
  'province.duel-testbed.gap-ne': 'Kirkwood Gap',
  'province.duel-testbed.belt-e': 'Eastern Ridge',
  'province.duel-testbed.crystal': 'Crystal Hulk',
  'province.duel-testbed.belt-sw': 'Dust Belt',
  'province.duel-testbed.gap-w': 'Western Gap',
  'province.duel-testbed.twin-a': 'Twin Ocean',
  'province.duel-testbed.outer-belt': 'Outer Belt',
  'province.duel-testbed.giant': 'Gas Colossus',
  'province.duel-testbed.io-moon': 'Forge Moon',
  'province.duel-testbed.trojan-l4': 'L4 Trojans',
  'province.duel-testbed.trojan-l5': 'L5 Trojans',
  'province.duel-testbed.wreck-1': 'Mass Grave',
  'province.duel-testbed.wreck-2': 'Flagship Hulk',
  'province.duel-testbed.debris-1': 'Shard Field',
  'province.duel-testbed.debris-2': 'Wreck Tail',
  'province.duel-testbed.last-camp': 'Last Camp',
  'province.duel-testbed.survey-1': 'Survey Point Alpha',
  'province.duel-testbed.singularity': 'Dead Star',
  'province.duel-testbed.relic': 'Keepers’ World',
  'province.duel-testbed.ring': 'Precursor Ring',
  'province.duel-testbed.station': 'Horizon Station',
  'province.duel-testbed.observatory': 'Observatory',
  'province.duel-testbed.survey-2': 'Survey Point Beta',
  'province.duel-testbed.scorched': 'Scorched World',
  'province.duel-testbed.scar-nw': 'Shockwave Scar',
  'province.duel-testbed.scar-s': 'Southern Scar',
  'province.duel-testbed.scar-e': 'Rupture Scar',
  'province.duel-testbed.core-1': 'Cloud Heart',
  'province.duel-testbed.core-2': 'Star Cradle',
  'province.duel-testbed.veil-w': 'Western Veil',
  'province.duel-testbed.veil-n': 'Northern Veil',
  'province.duel-testbed.veil-e': 'Eastern Veil',
  'province.duel-testbed.veil-s': 'Southern Veil',
  'province.duel-testbed.globule': 'Dark Globule',
  'province.duel-testbed.home-b': 'Cloud Capital',
  'province.duel-testbed.shore-b': 'Bright Shore',
  'province.duel-testbed.wisp': 'Filament',
  'province.duel-testbed.storm-1': 'Ion Wall',
  'province.duel-testbed.flare-1': 'Flare Corridor',
  'province.duel-testbed.storm-2': 'Ion Surge',
  'province.duel-testbed.flare-2': 'Corona',
  'province.duel-testbed.storm-3': 'Ion Flood',
  'province.duel-testbed.hot-world': 'Irradiated World',
  'province.duel-testbed.scoured': 'Scoured Waste',
  'province.duel-testbed.blaze': 'Blazing World',
  'province.duel-testbed.spent': 'Barren Rock',
  'province.duel-testbed.husk': 'Cooled World',
  'province.duel-testbed.tailings': 'Tailings',
  'province.duel-testbed.cinder': 'Slag World',
  'province.duel-testbed.old-colony': 'Old Colony',
  'province.duel-testbed.reach-w': 'Western Reach',
  'province.duel-testbed.reach-nw': 'Bare World',
  'province.duel-testbed.reach-se': 'Southern Reach',
  'province.duel-testbed.reach-n': 'Northern Giant',
  'province.duel-testbed.reach-sw': 'Rock Scatter',
  'province.duel-testbed.reach-e': 'Eastern Reach',
  'province.training-1.base': 'Expedition Base',
  'province.training-1.open-reach': 'Open Reach',
  'province.training-1.outpost': 'Forward Post',
  'province.training-1.target': 'Target Planet',
  'province.training-1.neutral': 'Neutral Planet',
  'province.training-1.asteroid-pass': 'Asteroid Pass',
  'province.training-1.station': 'Observation Station',
  ...
  'sector-zero.hero.joined': '⭐ {name} joins your squad!',
  'sector-zero.academy.by-chapter': 'chapter {n} reward',
  'sector-zero.academy.by-chapter.hint': 'Joins for free on your first win in chapter {n}. Or skip the wait and buy with data.',
  'sector-zero.academy.locked': 'Locked',
  'sector-zero.academy.rank': 'Stars: {n}★',
  'sector-zero.academy.tokens': 'Tokens: {n}/{goal}',
  'sector-zero.academy.tokens.join': 'Tokens: {n}/{goal} — the hero joins at {goal}',
  'sector-zero.academy.tab.battle': 'Battle',
  'sector-zero.academy.tab.tree': 'Progression',
  'sector-zero.academy.tab.stars': 'Stars',
  'sector-zero.academy.node.owned': 'learned',
  'sector-zero.academy.node.open': 'can learn',
  'sector-zero.academy.node.locked': 'locked',
  'sector-zero.academy.star.row': '{star}★ — skill slots: {slots}',
  'sector-zero.academy.star.ship': 'ship slot “{slot}”',
  'sector-zero.chapter.hero': 'Reward: {name} joins your squad',
  'sector-zero.chapter.hero.joined': '{name} is in your squad',
  'sector-zero.chapter.cleared': 'chapter cleared ✓',
  'sector-zero.chapter.tasks': 'bonus objectives: {n} of {m}',
  'sector-zero.chapter.waves': 'Waves: {n}',
  ...
  'yard.cost.troop': 'Trooper ×{n}',
  'yard.troop.none': 'No trooper can board here',
  ...
  'rescard.supply': 'Supplies',
  'rescard.supply.buy': 'Buy for {price} ◆',
  'rescard.supply.left': '{n} of {m} left this run',
  'rescard.supply.none': 'No supplies left this run',
  'rescard.supply.poor': 'Needs {price} ◆: not enough Sovereigns',
  'rescard.supply.done': 'Supplies delivered.',
  ...
  'onb.tour.stage': 'Stage {k} of {n}: {title}',
  'onb.tour.skip-stage': 'Skip stage',
  'onb.tour.collapse': 'Hide',
  'onb.tour.reopen': '💡 Hint',
  ...
  'sector-zero.cloud.choice.title': 'The cloud holds different progress',
  'sector-zero.cloud.choice.body': 'Keep one profile — the other is replaced.',
  'sector-zero.cloud.here': 'On this device',
  'sector-zero.cloud.cloud': 'In the cloud',
  'sector-zero.cloud.numbers':
    'Runs: {runs} · chapters: {chapters} · data: {research} · {warrants} ⌖ · {sovereigns} ◆',
  'sector-zero.cloud.keep-here': 'Keep this one',
  'sector-zero.cloud.take-cloud': 'Take from the cloud',
  'sector-zero.signin': 'Sign in',
  ...
  'sector-zero.codex.buildings': 'Structures',
  'sector-zero.codex.unknown': 'Not encountered',
  'sector-zero.codex.unit.seen': 'Up to {n} per formation · runs: {r}',
  'sector-zero.codex.veil.seen': 'Your strikes repelled: {n}',
  'sector-zero.codex.brood.seen': 'Spawns landers: you saw a landing',
  'sector-zero.codex.building.seen': 'Seen on Swarm worlds',
  ...
  'sector-zero.end.blueprint': 'Blueprint: {r}',
  'sector-zero.end.copies': 'Duplicates: {list}',
  'sector-zero.end.tokens': 'Hero tokens: {name} +{n}',
  'sector-zero.rarity.blueprints': 'Blueprints:',
  'sector-zero.rarity.hint': 'Rarity adds a new stat and raises the star cap: it takes a blueprint of the next tier and {n} duplicates.',
  'sector-zero.rarity.need': 'Blueprint {b}/1 · duplicates {c}/{m}',
  'sector-zero.rarity.raise': 'Raise rarity',
  'sector-zero.rarity.raised': 'Rarity raised: {r}',
  'sector-zero.rarity.to': 'Raise to: {r}',
  'sector-zero.shop.blueprint': 'Blueprint: {r}',
  'sector-zero.shop.blueprint.gives': 'Raises a module to this tier together with {n} duplicates',
  'sector-zero.shop.duplicate': 'arrives as a duplicate for rarity',
  'sector-zero.shop.grants.blueprint': 'Rarity blueprint',
  'sector-zero.shop.grants.hero-tokens': 'Hero tokens',
  'sector-zero.shop.tokens': '{name}: tokens ×{n}',
  'sector-zero.shop.tokens.max': 'Hero stars are maxed',
  ...
  'sector-zero.hull.max': '{n} slots — the maximum',
  'sector-zero.hull.star': 'Star {n}: +1 slot',
  ...
  'sector-zero.forge.title': 'Upgrade ★',
  ...
  'sector-zero.map.close': 'Close map',
  'sector-zero.map.fog': 'Unscouted',
  'sector-zero.map.hostile': 'Enemy',
  'sector-zero.map.lost': 'No contact with the district — map unavailable',
  ...
  'sector-zero.mission.1.brief': 'A border district: first contact with the Swarm.',
  'sector-zero.mission.2.brief': 'The expedition graveyard, overrun by the Swarm.',
  'sector-zero.mission.3': 'III · Quarantine Line',
  'sector-zero.mission.3.brief': 'Three crossings through the quarantine line. Hold them without running out of reserve.',
  'sector-zero.mission.lost': 'Signal lost',
  'sector-zero.mission.lost.brief': 'No contact with this district. The chapter is still closed.',
  'sector-zero.prep': 'Prepare for a run',
  'sector-zero.training': 'Training',
  'sector-zero.training.hint': 'Clearance Protocol: a training simulation before Chapter I',
  'training.started': 'Simulation active. Objective: restore control of the training district. Ship losses are virtual. Your decisions are not.',
  'training.goal': 'Goal: take the training opposition’s forward post and target planet',
  'training.missions.hint': 'Optional tasks: they do not decide victory.',
  'training.end.none': 'Simulation: no experience or profile rewards',
  'training.end.again': 'Replay training',
  'training.stage.prep': 'Preparation',
  'training.stage.economy': 'Base and economy',
  'training.stage.research': 'Research',
  'training.stage.expand': 'Expansion',
  'training.stage.missions': 'Missions',
  'training.stage.fleet': 'Fleet control',
  'training.stage.battle': 'Battle and hero',
  'training.stage.retreat': 'Retreat and repair',
  'training.stage.carrier': 'Carrier',
  ...
  'sector-zero.prep.hero-level': 'Stars {n}★ · skill slots: {slots}',
  ...
  'sector-zero.prep.hero-ship': 'Hero ship',
  'sector-zero.prep.hero-ship.hint': 'Flies with the selected hero. Each hero star: +1 module slot.',
  'sector-zero.prep.hero-ship.off-run': 'Only the selected hero\'s ship joins the expedition — pick the hero in the Academy.',
  'sector-zero.prep.hero-ships': 'Hero ships',
  'sector-zero.prep.hero-ship.next': 'Star {n}★: +1 slot — {slot}.',
  'sector-zero.prep.hero-upgrade': 'Star {star}★: +1 skill and ship slot · {n} tokens',
  ...
  'sector-zero.tab-taken.title': 'Sector Zero is open in another tab',
  'sector-zero.tab-taken.text': 'That tab saves your progress. This one is paused so the two do not overwrite each other.',
  'sector-zero.tab-taken.here': 'Play here',
  ...
  'sector-zero.comic.title': 'Chapter comic',
  'sector-zero.comic.skip': 'Skip',
  ...
  'sector-zero.shop.hint': 'Modules, skills, resources, rarity blueprints and hero tokens. A module you already own arrives as a duplicate. Each item is sold by its own payment methods.',
  ...
  'swarm.journal.title': 'How the Swarm adapts',
  'swarm.journal.tier.fact': 'Fact',
