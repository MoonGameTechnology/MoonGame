...
| TXT-0.1 | ✅ | docs | `docs/backlog.md:15738` | Канон формулировок: записать правило и эталон, пока чистка не |
| TXT-1 | ⏳ | proto | `docs/backlog.md:15775` | Досье зданий: 14 ключей, 2505 симв., проза вместо |
| TXT-2 | ⏳ | proto | `docs/backlog.md:15788` | Досье юнитов: 10 ключей, 3046 симв. — самый раздутый домен |
| TXT-3 | ⏳ | proto | `docs/backlog.md:15799` | Тавтологии и дубли в досье — чистая вырезка, самый дешёвый |
| TXT-4 | ⏳ | proto | `docs/backlog.md:15814` | Герои: описание способности не называет величину — 10 из |
| TXT-5 | ⏳ | proto | `docs/backlog.md:15831` | Онбординг: 36 ключей, 5019 симв. — учит законно, но |
| TXT-6 | ⏳ | proto | `docs/backlog.md:15845` | Кодекс: 7 статей, средн. 187 симв. — тренерский хвост в |
| TXT-7 | 🔒 | proto docs | `docs/backlog.md:15854` | Сторож в гейте: чтобы вода не вернулась. |
