...
> **Гейт:** `pnpm run check` (lint + typecheck + test + docs-check). **Тесты: 4883 зелёных** (58 skip, 372 файла).
...
packages/action-layer/src/
  ...
  modules/       army, arsenalSync, artillery, capital, captureOnArrival, combat, construction, diplomacy, economy, effects, espionage, faction, fleetOps, fleetRepair, forcedMarch, hero, heroEffects, instantRepair, intercept, market, movement, orbital, planetType, pve, scientist, sector, squadron, standingOrders, station, steward, tax, technology, victory, visibility  (34 модуля, + *.test.ts)
...
**✅ Этап 1 (ядро) — готово целиком:** 34 модуля на микроядре (шина/хуки/манифест,
