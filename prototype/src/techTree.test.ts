...
// CONV-16. Правило («капстоун ветки гейтит учёный этой ветки») записано в одноимённом
// кирпиче `docs/backlog.md`; оно тихо сломалось, когда состав учёных сократили до трёх:
