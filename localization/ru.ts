...
export const ru: Record<string, string> = {
  ...
  'cmd.target': 'Приказ',
  'cmd.target.hint':
    'режим плана: тапай точки карты — курс · ждать · штурм · огонь; флот исполнит цепочку сам',
  ...
  'codex.term.upkeep.body':
    'Флоты и здания требуют ежедневной платы. Доход от металлодобычи минус содержание = чистый баланс; уйдёшь в минус — казна опустеет. Строй экономику раньше армии.',
  ...
  'hint.pick-order': 'тапни точку на карте — каждый тап добавляет приказ',
  ...
  'onb.goal.mine': 'Улучши металлодобычу',
  ...
  'onb.tour.first.home':
    'Внизу откроется панель твоего домашнего мира: здания, гарнизон и стройка. Тапни свой мир, чтобы её открыть.',
  'onb.tour.first.mine':
    'Начни с экономики: улучши Металлодобычу — так вырастет доход металла, на который строится всё остальное.',
  'onb.tour.first.scan':
    'Хочешь узнать характеристики корабля или флота? Тапни по нему (на ПК — наведи курсор): откроется карточка с уроном, бронёй, скоростью и вместимостью десанта.',
  'onb.tour.first.score':
    'Мир взят — и счёт пошёл! Очки капают за миры и сектора; набери порог — и это победа.',
  'onb.tour.first.spy':
    'Перед атакой на чужой мир его стоит разведать: тапни вражеский мир → «Разведать мир» (или вкладка «Дипломатия → Шпионаж») — на 24 часа увидишь его гарнизон и флоты. Здесь соперников нет, но в настоящем матче это убережёт от засады.',
  'onb.tour.first.troops':
    'У флота есть трюм для десанта: выбери его на своём мире и нажми ⇅ «Десант» в ряду команд — там видно, кого и сколько можно взять на борт. Открытый мир берёшь одной орбитой, а мир с гарнизоном — только высадкой: сначала флот собьёт оборону сверху, потом десант берёт землю.',
  ...
  'onb.tour.hud.purse':
    'Твоя казна: доход от металлодобычи минус содержание флота. Следи, чтобы не уйти в минус.',
