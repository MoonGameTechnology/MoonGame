...
- Действие **`fleet.bombard {on}`** — тумблер бомбардировки (стоя на орбите,
  ...
  **ORB-1 — орбитальный слой есть РОВНО у двух видов узла:** `planet` и `void_station`
  ...
  не обстрелять и зубов ПКО им не завести. Правило объявлено флагом `sectorKinds[kind].orbit`
