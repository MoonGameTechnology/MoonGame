...
export const ru: Record<string, string> = {
  ...
  'dossier.unit.strike-carrier.desc':
    'Десантный корабль: самый большой трюм во флоте ({c} мест) на самом толстом корпусе ({hp}). Он не воюет — {a} атаки это ничто, — он довозит армию к чужому миру и держит удар, пока она высаживается. Шаттлов не несёт: ангар только у «Шаттла».',
  ...
  'sector-zero.map.target': 'Цель задачи',
  ...
  'sector-zero.shop.hint': 'Модули, навыки и ресурсы. Каждый товар продаётся своими способами оплаты.',
