...
openssl с фиксом `3.5.7-1~deb13u2`, недоступным внутри distroless). Записи «фикса не
существует» — их был 21 — удалены: гейт их и так пропускает, а подавление резало их
