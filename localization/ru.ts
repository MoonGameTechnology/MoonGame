...
export const ru: Record<string, string> = {
  ...
  // --- controls — раздел «Управление» в настройках (UX-KEYS-1, decisions/controls.ts).
  'controls.add.does': 'Добавить флот к выделению',
  'controls.add.keys': 'Ctrl или Shift + клик по флоту',
  'controls.back.does': 'Назад: закрыть верхнее окно',
  'controls.back.keys': 'Esc',
  'controls.box.does': 'Рамка выделения флотов (с пустого места)',
  'controls.box.keys': 'Shift + перетаскивание',
  'controls.dblclick.does': 'Вид по умолчанию',
  'controls.dblclick.keys': 'Двойной клик по карте',
  'controls.double-tap.keys': 'Двойной тап по карте',
  'controls.drag.does': 'Двигать карту',
  'controls.drag.keys': 'ЛКМ + перетаскивание',
  'controls.long-press.does': 'На своём флоте — добавить к выделению или убрать; на пустом месте — рамка',
  'controls.long-press.keys': 'Долгое нажатие',
  'controls.pinch.does': 'Масштаб',
  'controls.pinch.keys': 'Щипок двумя пальцами',
  'controls.quick-build.does': 'Заказать без окна подтверждения',
  'controls.quick-build.keys': 'ПКМ по плитке постройки',
  ...
  'battle.win.veteran-both': 'Выслуга: +{n}% урона и +{h}% прочности за пережитые бои',
  'battle.win.veteran-hull': 'Выслуга: +{h}% прочности за пережитые бои',
  ...
  'battle.win.phase.ground': 'наземная фаза',
  'battle.win.phase.orbit': 'орбитальная фаза',
  'battle.win.round': 'раунд {r}',
  'battle.win.shield': 'щит',
  'battle.win.sides': 'стороны — {n}',
  ...
  'shipcard.codex': 'Справочник корпуса',
  'shipcard.empty': 'пусто',
  'shipcard.extra': 'сверх ёмкости',
  'shipcard.loadout': 'Оснащение · {n}/{m}',
  'shipcard.loadout.none': 'У корпуса нет отсеков для модулей',
  'shipcard.stars': 'Звёзд: {n}',
  'shipcard.stat.pd': 'Зональное ПВО',
  'shipcard.stats': 'Один корабль: корпус → с оснащением',
  ...
  'build.lander.troop': 'Боец на борту',
  'build.cat.all': 'ВСЕ',
  ...
  'chat.you': 'Вы',
  'data.fortress-guns': 'орудия крепости',
  'data.garrison': 'гарнизон',
  'data.fortress-hangar': 'ангар крепости',
  'data.landing-shuttle': 'десантный челнок',
  'donate.aria': 'Суверены: {n}. Пополнить',
  'donate.soon': 'Магазин Суверенов — скоро',
  'dossier.unit.landing-shuttle.desc': 'Десантный челнок: безоружный борт с одним наземным бойцом внутри — бойца выбирают при заказе, цена — челнок плюс боец. По кораблям не бьёт вовсе, отказ приходит прямо на приказе. Летит один раз: садится и становится этим бойцом. Пустой чужой мир берёт сразу, обороняемый — высаживает ПЛАЦДАРМ и завязывает наземный бой без единого корабля рядом; на свой мир возит подкрепление. Зональное ПВО режет и машины, и то, что они везли ({hp} корпуса, радиус {r}). Место в трюме: {cs}, с любым бойцом.',
  ...
  'side.fortress.or': ' или ',
  'side.fortress.to-tech': 'Открыть технологии',
  'side.wing.aloft': 'в вылете, мест: {n}',
  ...
  'side.wing.blocked.rearming.hold': 'борт перезаряжает звенья — вылет позже',
  ...
  'side.wing.hangar': 'Ангар порта — {used}',
  'side.wing.hold': 'Трюм — {used} из {bay}',
  'side.wing.hull': 'подбит: корпус {p}%',
  'side.wing.load': '↑ На борт',
  'side.wing.no-port': 'нет космопорта — шаттлов тут не держат',
  'side.wing.places': 'мест: {n}',
  ...
  'hud.hull': 'корпус',
  'hud.in-combat': 'в бою',
  'hud.order.assault': 'Штурм',
  'hud.order.bombard-off': 'Прекратить обстрел',
  'hud.order.bombard-on': 'Обстрел',
  'hud.order.forcemarch-off': 'Отменить форс-марш',
  'hud.order.forcemarch-on': 'Форс-марш',
  'hud.order.stop': 'Остановить',
  'hud.merge.into': 'Слить {fleet} ({n})',
  'hud.split.all': 'всё',
  'hud.split.confirm': 'Разделить',
  'hud.split.hold': 'Трюм: уходит {taken}, остаётся {kept}',
  'hud.split.open': 'Разделить',
  'hud.split.ships': 'Кораблей уходит {take} из {total}',
  'hud.split.title': 'Разделить флот {fleet}',
  "data.biomass": "Биомасса",
  "hud.resource.biomass": "Биомасса",
  "data.swarm-brood-mother": "Матка Роя",
  "data.swarm-lander": "Захватчик Роя",
  "data.synaptic-digester": "Синаптический переработчик",
  "data.swarm-relay": "Большой ретранслятор Роя",
  "data.swarm-relay-small": "Малый ретранслятор Роя",
  "data.swarm-data-center": "Центр данных Роя",
  "data.brood-chamber": "Выводковая камера",
  "swarm.brood.desc": "Живой выводковый орган Матки. Каждые 3 игровых часа выращивает одного Захватчика на носитель: 20 биомассы, 8 металла и 2 микроэлектроники. Рост останавливается в бою, при нехватке сырья или места для десанта.",
  'data.swarm-leviathan': 'Левиафан',
  'data.leviathan': 'Левиафан',
  'data.leviathan-brood': 'Выводок Левиафана',
  'swarm.leviathan-brood.desc':
    'Выводковое чрево Левиафана. Каждые 3 игровых часа выращивает 6 Захватчиков: по 20 биомассы, 8 металла и 2 микроэлектроники за каждого. Рост останавливается в бою, при нехватке сырья или места для десанта.',
  'data.hive-call': 'Зов улья',
  'data.devour-world': 'Поглощение мира',
  'data.swarm-instinct': 'Стайный инстинкт',
  "swarm.intel.economy": "Рой поглощает органику для живых тканей, металл — для опор и панцирей, микроэлектронику — для выращивания проводящих нейронных узлов. Промышленные миры питают его экспансию: одной биомассы недостаточно.",
  "swarm.intel.brood": "Матка несёт выводковую камеру — орган выращивания наземных Захватчиков. Она расходует биомассу, металл и микроэлектронику; существа занимают место десанта и захватывают поверхность обычным штурмом. Присутствие Матки само по себе мир не заражает.",
  'swarm.intel.updated': 'Новые данные',
  'swarm.intel.tab': 'Досье',
  'swarm.intel.title': 'Досье Роя',
  'swarm.intel.lore': 'Наблюдая Рой при каждом контакте, мы изучаем его состав и изменения. Здесь только замеченные соединения, а не вся армия Роя.',
  'swarm.intel.empty': 'Опознанных соединений пока нет. Радарная засечка не раскрывает состав.',
  'swarm.intel.live': 'На радаре',
  'swarm.intel.stale': 'Сейчас не видно — состав мог измениться',
  'swarm.intel.stale.short': 'Видели раньше',
  // Досье справа и сворачиваемое (заказ владельца 2026-09-23): сводка видна и в свёрнутом.
  'swarm.intel.badge': 'Замечено сил: {seen} · на радаре: {live}',
  'swarm.intel.badge.none': 'Силы Роя пока не замечены',
  'swarm.intel.forces': 'Замеченные силы',
  'swarm.intel.jump': 'Показать на карте',
  'swarm.intel.about': 'О Рое',
  'swarm.intel.fold': 'Свернуть досье',
  ...
  'pve.pirates.travel': 'Флот идёт к базе. При встрече с пиратами бой начнётся сам. Дождитесь прибытия; скорость времени можно менять внизу экрана.',
  'pve.pirates.battle': 'Сражение началось. Откройте окно боя: там состав сторон, прочность и отсчёт до следующего раунда. Урон проходит по раундам. Отступление задаётся через карточку своего флота.',
  'pve.pirates.occupy': 'Флот пиратов разбит, но база ещё принадлежит им. В стартовом флоте есть десант: переведите флот на ближнюю орбиту и отдайте «Штурм», чтобы занять пустую базу.',
  'pve.pirates.won': 'База взята, первый бой завершён. Проверьте потери своего флота и готовьте оборону против Роя. Победа в экспедиции ещё впереди.',
  'pve.pirates.cleared': 'Пиратская цель уже зачищена. Продолжайте подготовку к волнам Роя.',
  'pve.pirates.recover': 'Сейчас у вас нет боевого флота. Пополните силы на домашней верфи или оставьте пиратов на потом. Экспедиция продолжается.',
  'pve.pirates.show': 'Показать базу',
  'pve.pirates.open-battle': 'Открыть сражение',
  'run.abandon.lost.title': 'Флот потерян',
  'run.abandon.lost.text': 'Кораблей не осталось. Отстройтесь на верфи или завершите экспедицию: награда за волны, задачи и уничтоженных врагов — как за поражение.',
  'run.abandon.ask.title': 'Завершить экспедицию?',
  'run.abandon.ask.text': 'Экспедиция сразу закончится поражением. Награда: за волны, задачи и уничтоженных врагов.',
  'run.abandon.rebuild': 'Отстроиться',
  'run.abandon.back': 'Продолжить',
  'run.abandon.go': 'Завершить экспедицию',
  'run.exit.title': 'Выйти из экспедиции?',
  'run.exit.text': 'В меню — экспедиция сохранится, продолжите с того же места. Завершить — поражение; награда за волны, задачи и уничтоженных врагов.',
  'run.exit.double': 'На итогах её можно удвоить за ролик.',
  'run.exit.reward': 'Заберёте сейчас: +{n} данных, +{w} ⌖',
  'run.exit.menu': 'В меню',
  'run.exit.go': 'Завершить и забрать награду',
  'pve.pirates.continue': 'Продолжить экспедицию',
  'pve.pirates.hide': 'Скрыть подсказку',
  'hud.world.capital': '★ Столица',
  'hud.world.hold-clear': 'Снять точку удержания',
  'hud.world.hold-full': 'Точки удержания исчерпаны',
  'hud.world.hold-set': 'Точка удержания',
  'hud.world.make-capital': 'Сделать столицей',
  'hud.world.no-garrison': 'гарнизона нет',
  'hud.world.nobody': 'ничей',
  'hud.world.remembered': 'по памяти: данные могли устареть',
  ...
  'codex.row.aa': 'ПКО',
  // МЕДАЛИ ВЕТЕРАНА (VET-3/VET-5). Две линии, разведённые ОБРАЗНО, а не только словами:
  // доблесть — огонь и звёзды, выслуга — корабль и железо. На карточке телефона игрок
  // различит их раньше, чем прочитает. Степени по возрастанию; номер степени игроку не
  // показывается никогда — только имя.
  'medal.valour': 'Доблесть',
  'medal.valour.1': 'Искра',
  'medal.valour.2': 'Разящий залп',
  'medal.valour.3': 'Багровая звезда',
  'medal.valour.4': 'Гаснущее солнце',
  'medal.service': 'Выслуга',
  'medal.service.1': 'Первый шрам',
  ...
  'data.heavy-cruiser': 'усиленный крейсер',
  ...
  'data.heavy-striker': 'тяжёлый ударный страйкер',
  'data.hero': 'флагман',
  ...
  'data.swarm-collective': 'Рой',
  'data.training-opposition': 'Учебный противник',
  'data.vanguard-compact': 'Пакт авангарда',
  ...
  'dossier.building.fabricator':
    'Чистые цеха литографии печатают {m}▦ в час. Прожорлива к энергии и людям, зато её продукция ведёт шаттлы и открывает осадные доктрины. Апгрейды окупаются собственной продукцией.',
  ...
  'dossier.building.orbital-aa':
    'Орбитальное ПКО: стационарная батарея бьёт по КОРАБЛЯМ на орбите — {dmg} урона в час. Против шаттлов она бесполезна: те влетают в воздушное пространство, и там их встречает зональное ПВО. Захват мира батарея не блокирует — это дело наземной обороны; она лишь выкашивает флот над головой.',
  'dossier.building.zonal-aa':
    'Зональное ПВО: батарея встречает ШАТТЛЫ, влетевшие в воздушное пространство мира, — {dmg} урона по волне в момент удара. Без неё удар шаттлов по вашему миру безответен: они бьют и уходят целыми. С ней половина волны не возвращается домой. По кораблям на орбите не работает вовсе — это дело ПКО.',
  ...
  'dossier.tab.ships.desc': 'Флоты на орбите и очередь заказа кораблей.',
  'dossier.tab.ships.name': 'Флот',
  'dossier.tab.shuttle.desc':
    'Эскадра космопорта: машины (△) стоят в ангаре мира, на карте их нет. Кнопка удара поднимает вылет, цель выбирается тапом по карте. Корабль с трюмом возит эскадру с собой — трюм показан в панели флота.',
  ...
  'dossier.unit.bomber.desc':
    'Ударный страйкер: шаттл против КОРПУСОВ — {a} урона по кораблю, вдвое тяжелее перехватчика. По постройкам работает средне ({s} в час): мир он потреплет, но сносить его — дело осадных платформ. Тяжелее и медленнее перехватчика ({hp} корпуса, радиус {r}), дольше перезаряжается, в бой не вступает: подлетел, ударил, ушёл домой. Место в трюме: {cs}.',
  'dossier.unit.bomber.name': 'Ударный страйкер',
  'dossier.unit.heavy-striker.desc':
    'Тяжёлый ударный страйкер: {a} урона по кораблю, {s} в час по постройкам, радиус {r} — достаёт соседнюю провинцию. Медленнее ударного, {hp} корпуса, дольше перезаряжается. Место в трюме: {cs}. Открывают «Ударные векторы».',
  'dossier.unit.heavy-striker.name': 'Тяжёлый ударный страйкер',
  ...
  'dossier.unit.picket-frigate.desc':
    'Дозорный фрегат: глаза флота. Своя антенна — {r}, а радар-модуль (+{m}) встаёт только на него. Почти не воюет ({a} атаки, {d} защиты, {hp} корпуса) и держится в задней линии. Отсеков под модули: {n}.',
  'dossier.unit.picket-frigate.name': 'Дозорный фрегат',
  ...
  // SHU-4.1: её ступени были авиационными, а те принадлежат шаттлам («эскадра»).
  ...
  'hint.pick-engage': 'ткните во вражеский флот или в мир, где он стоит, — атакуем',
  ...
  'loadout.stat.hull-repair': 'Ремонт корпуса',
  'loadout.stat.radar': 'Радар',
  'loadout.stat.shield-regen': 'Восстановление щита',
  'loadout.stat.share-per-hour': '{n}%/ч',
  'loadout.stat.shield': 'Щит',
  'loadout.stat.siege': 'Урон по постройкам',
  ...
  'province.pve-1.drift': 'Каменный дрейф',
  'province.pve-1.veil': 'Серая пелена',
  'province.pve-1.cluster': 'Рудное скопление',
  'province.pve-1.shoal': 'Маячная отмель',
  'province.pve-1.shear': 'Ионный разлом',
  'province.pve-1.ridge': 'Грозовой гребень',
  'province.pve-1.hive': 'Пепельный улей',
  'province.pve-1.ford': 'Звёздный брод',
  'province.pve-1.cove': 'Мглистая заводь',
  'province.pve-2.landing': 'Плацдарм',
  'province.pve-2.rim-veil': 'Краевая вуаль',
  'province.pve-2.cold-shoal': 'Холодная отмель',
  'province.pve-2.dig-site': 'Раскоп',
  'province.pve-2.wreck-spine': 'Хребет обломков',
  'province.pve-2.flare-belt': 'Пояс вспышек',
  'province.pve-2.rockfield': 'Каменное поле',
  'province.pve-2.dust-reach': 'Пыльный тракт',
  'province.pve-2.ore-knot': 'Рудный узел',
  'province.pve-2.ion-wall': 'Ионная стена',
  'province.pve-2.hollow': 'Тихая лощина',
  'province.pve-2.wreck-tail': 'Хвост обломков',
  'province.pve-2.camp': 'Брошенный лагерь',
  'province.pve-2.relay': 'Ретранслятор',
  'province.pve-2.drift-moon': 'Блуждающая луна',
  'province.pve-2.spore-cloud': 'Споровое облако',
  'province.pve-2.scree': 'Осыпь',
  'province.pve-2.deep-drift': 'Глубокий дрейф',
  'province.pve-2.veil-deep': 'Глубокая вуаль',
  'province.pve-2.biopit': 'Биояма',
  'province.pve-2.brood-yard': 'Инкубатор',
  'province.pve-2.nest': 'Гнездо',
  'province.pve-2.salvage-pocket': 'Карман трофеев',
  'province.pve-2.bone-drift': 'Костяной дрейф',
  'province.pve-3.bastion': 'Бастион Кордон',
  'province.pve-3.west-colony': 'Западная колония',
  'province.pve-3.east-colony': 'Восточная колония',
  'province.pve-3.north-reach': 'Северный простор',
  'province.pve-3.gate-yard': 'Привратный двор',
  'province.pve-3.ore-shelf': 'Рудный уступ',
  'province.pve-3.hinter-veil': 'Тыловая вуаль',
  'province.pve-3.watch-post': 'Дозорный пост',
  'province.pve-3.north-gate': 'Северные врата',
  'province.pve-3.east-haze': 'Восточная дымка',
  'province.pve-3.front-w': 'Западная передовая',
  'province.pve-3.front-e': 'Восточная передовая',
  'province.pve-3.rift-far-w': 'Разлом Бездна',
  'province.pve-3.west-pass': 'Западный перевал',
  'province.pve-3.rift-w': 'Разлом Клин',
  'province.pve-3.quarantine': 'Карантинная зона',
  'province.pve-3.rift-e': 'Разлом Шов',
  'province.pve-3.east-pass': 'Восточный перевал',
  'province.pve-3.rift-far-e': 'Разлом Пасть',
  'province.pve-3.south-west': 'Юго-западный риф',
  'province.pve-3.beachhead': 'Плацдарм Роя',
  'province.pve-3.spore-reach': 'Споровый тракт',
  'province.pve-3.wreck-w': 'Кладбище кораблей',
  'province.pve-3.storm-e': 'Восточный шторм',
  'province.pve-3.biofarm-w': 'Западная биоферма',
  'province.pve-3.biofarm-e': 'Восточная биоферма',
  'province.pve-3.beacon-rock': 'Маячная скала',
  'province.pve-3.hive': 'Чумной улей',
  'province.duel-testbed.home-a': 'Столица Пояса',
  'province.duel-testbed.belt-n': 'Северная гряда',
  'province.duel-testbed.gap-ne': 'Щель Кирквуда',
  'province.duel-testbed.belt-e': 'Восточная гряда',
  'province.duel-testbed.crystal': 'Кристальная глыба',
  'province.duel-testbed.belt-sw': 'Пылевой пояс',
  'province.duel-testbed.gap-w': 'Западная щель',
  'province.duel-testbed.twin-a': 'Океан-близнец',
  'province.duel-testbed.outer-belt': 'Внешний пояс',
  'province.duel-testbed.giant': 'Газовый исполин',
  'province.duel-testbed.io-moon': 'Кузня-луна',
  'province.duel-testbed.trojan-l4': 'Троянцы L4',
  'province.duel-testbed.trojan-l5': 'Троянцы L5',
  'province.duel-testbed.wreck-1': 'Братская могила',
  'province.duel-testbed.wreck-2': 'Остов флагмана',
  'province.duel-testbed.debris-1': 'Поле осколков',
  'province.duel-testbed.debris-2': 'Хвост крушения',
  'province.duel-testbed.last-camp': 'Последний лагерь',
  'province.duel-testbed.survey-1': 'Точка съёмки «Альфа»',
  'province.duel-testbed.singularity': 'Мёртвая звезда',
  'province.duel-testbed.relic': 'Мир хранителей',
  'province.duel-testbed.ring': 'Кольцо Предтеч',
  'province.duel-testbed.station': 'Станция Горизонт',
  'province.duel-testbed.observatory': 'Обсерватория',
  'province.duel-testbed.survey-2': 'Точка съёмки «Бета»',
  'province.duel-testbed.scorched': 'Опалённый мир',
  'province.duel-testbed.scar-nw': 'Шрам Ударной',
  'province.duel-testbed.scar-s': 'Южный шрам',
  'province.duel-testbed.scar-e': 'Шрам Разрыва',
  'province.duel-testbed.core-1': 'Сердце облака',
  'province.duel-testbed.core-2': 'Колыбель звёзд',
  'province.duel-testbed.veil-w': 'Западная вуаль',
  'province.duel-testbed.veil-n': 'Северная вуаль',
  'province.duel-testbed.veil-e': 'Восточная вуаль',
  'province.duel-testbed.veil-s': 'Южная вуаль',
  'province.duel-testbed.globule': 'Тёмная глобула',
  'province.duel-testbed.home-b': 'Столица Облака',
  'province.duel-testbed.shore-b': 'Светлый берег',
  'province.duel-testbed.wisp': 'Волокно',
  'province.duel-testbed.storm-1': 'Ионная стена',
  'province.duel-testbed.flare-1': 'Коридор вспышек',
  'province.duel-testbed.storm-2': 'Ионный вал',
  'province.duel-testbed.flare-2': 'Корона',
  'province.duel-testbed.storm-3': 'Ионный разлив',
  'province.duel-testbed.hot-world': 'Облучённый мир',
  'province.duel-testbed.scoured': 'Выжженная пустошь',
  'province.duel-testbed.blaze': 'Пылающий мир',
  'province.duel-testbed.spent': 'Пустая порода',
  'province.duel-testbed.husk': 'Остывший мир',
  'province.duel-testbed.tailings': 'Отвалы',
  'province.duel-testbed.cinder': 'Шлаковый мир',
  'province.duel-testbed.old-colony': 'Старая колония',
  'province.duel-testbed.reach-w': 'Западный простор',
  'province.duel-testbed.reach-nw': 'Голый мир',
  'province.duel-testbed.reach-se': 'Южный простор',
  'province.duel-testbed.reach-n': 'Северный исполин',
  'province.duel-testbed.reach-sw': 'Каменная россыпь',
  'province.duel-testbed.reach-e': 'Восточный простор',
  'province.training-1.base': 'Экспедиционная база',
  'province.training-1.open-reach': 'Открытый участок',
  'province.training-1.outpost': 'Передовой пост',
  'province.training-1.target': 'Планета-цель',
  'province.training-1.neutral': 'Нейтральная планета',
  'province.training-1.asteroid-pass': 'Астероидный проход',
  'province.training-1.station': 'Наблюдательная станция',
  ...
  'sector-zero.hero.joined': '⭐ {name} присоединяется к отряду!',
  'sector-zero.academy.by-chapter': 'награда главы {n}',
  'sector-zero.academy.by-chapter.hint': 'Придёт сам за первую победу в главе {n}. Не хотите ждать — купите за данные.',
  'sector-zero.academy.locked': 'Закрыт',
  'sector-zero.academy.rank': 'Звёзды: {n}★',
  'sector-zero.academy.tokens': 'Жетоны: {n}/{goal}',
  'sector-zero.academy.tokens.join': 'Жетоны: {n}/{goal} — на {goal} герой присоединится',
  'sector-zero.academy.tab.battle': 'В бой',
  'sector-zero.academy.tab.tree': 'Развитие',
  'sector-zero.academy.tab.stars': 'Звёзды',
  'sector-zero.academy.node.owned': 'изучен',
  'sector-zero.academy.node.open': 'можно изучить',
  'sector-zero.academy.node.locked': 'закрыт',
  'sector-zero.academy.star.row': '{star}★ — слотов навыков: {slots}',
  'sector-zero.academy.star.ship': 'слот корабля «{slot}»',
  'sector-zero.chapter.hero': 'Награда: {name} присоединится к отряду',
  'sector-zero.chapter.hero.joined': '{name} — в отряде',
  'sector-zero.chapter.cleared': 'глава пройдена ✓',
  'sector-zero.chapter.tasks': 'доп. задач: {n} из {m}',
  'sector-zero.chapter.waves': 'Волн: {n}',
  // --- sandbox — Песочница (дев-инструмент): переключатели и команды.
  'sector-zero.dev.start': 'Dev-экспедиция',
  'sector-zero.dev.hint': 'Тестовая попытка: без сохранения и наград. Обычная экспедиция останется доступна.',
  ...
  'sci.wing-commodore.desc':
    'Лидер ветки шаттлов: полётные палубы, векторы удара, программы асов.',
  ...
  'threat.contact': '◆ новый радарный контакт ({size}) · {at}',
  'threat.here': '⚠ {node}: враг здесь!',
  'threat.incoming': '⚠ {node}: враг на подходе, прибытие через {dur}',
  ...
  'yard.cost.troop': 'Боец ×{n}',
  'yard.troop.none': 'На этом мире некого посадить в челнок',
  ...
  'yard.tab.squads': 'Шаттлы',
  'yard.tab.support': 'Поддержка',
  ...
  'err.already-researched': 'технология уже изучена или уже в работе',
  'err.already-shared': 'карта этой державе уже открыта',
  'err.already-taken': 'это усиление уже взято',
  'err.already-unlocked': 'узел уже изучен',
  'err.bad-effect': 'способность настроена некорректно',
  'err.bad-payload': 'некорректный приказ',
  'err.bad-posture': 'неизвестный режим Хранителя',
  'err.bad-spawn': 'здесь нельзя развернуть героя',
  'err.bad-target': 'недопустимая цель',
  'err.bad-until': 'срок делегирования должен быть в будущем',
  'err.bombarded': 'стройка под бомбардировкой',
  'err.bot-alliance': 'боты не вступают в коалиции',
  'err.cannot-retreat': 'отступить может сторона боя, а не десант',
  ...
  'err.duplicate-scientist': 'этот учёный уже в совете',
  'err.embargo': 'эмбарго: торговля с этой державой закрыта',
  'err.empty-garrison': 'гарнизон пуст',
  ...
  'err.hangar-full': 'ангар полон',
  'err.has-cargo': 'сначала разгрузите трюм',
  ...
  'err.hero-deployed': 'герой уже в поле — командуйте им через его флот',
  'err.hero-fallen': 'босс пал и не вернётся',
  'err.hero-not-deployed': 'герой не развёрнут — сначала поднимите корабль',
  'err.hero-unit': 'корабль героя не отделяется от его флота',
  'err.host-in-transit': 'флот в пути — корабль героя поднимают на стоянке',
  'err.immobile': 'это сооружение не поднимается с места',
  'err.in-battle': 'флот в бою',
  'err.in-transit': 'флот в пути',
  'err.insufficient': 'не хватает ресурсов',
  'err.internal': 'внутренняя ошибка',
  'err.invalid-target': 'этой эскадре нечем бить',
  'err.lane-busy': 'производственная полоса занята',
  'err.limit': 'достигнут предел',
  'err.max-level': 'достигнут максимальный уровень',
  ...
  'err.no-mapshare': 'обмена картами с этой державой нет',
  'err.no-module': 'у героя нет этого модуля',
  'err.no-node': 'неизвестный узел дерева',
  'err.no-order': 'лот не найден',
  'err.no-planet': 'мир не найден',
  'err.no-player': 'игрок не найден',
  'err.no-port': 'нужен космопорт — шаттлы живут в его ангаре',
  'err.no-range': 'у эскадры нет боевого радиуса',
  ...
  'err.no-snapshot': 'у этого места нет арсенала',
  'err.no-speed': 'эскадра не может лететь',
  'err.no-squadron': 'соединение не найдено',
  'err.no-target': 'нет цели',
  'err.no-target-position': 'где цель — неизвестно',
  'err.no-troops': 'мир защищён — для штурма нужен десант на борту',
  'err.not-a-lane': 'из коридора не свернуть — доезжайте до конца',
  'err.not-active': 'эта работа уже не идёт',
  'err.not-colocated': 'флоты не в одной точке',
  'err.not-delegated': 'Хранитель не назначен',
  'err.not-destructible': 'этот мир нельзя уничтожить',
  'err.not-capturable': 'этот сектор нельзя захватить — там нечего занимать',
  'err.not-pve': 'это не экспедиция',
  'err.not-stationable': 'здесь крепость не поставить — это уже мир либо уже крепость',
  'err.not-enough': 'столько не наберётся',
  'err.not-equipped': 'у героя нет этой способности',
  'err.not-ground': 'в трюм грузится только наземная армия',
  'err.not-bombarding': 'флот не ведёт бомбардировку',
  'err.not-hostile': 'это не враг',
  'err.not-in-battle': 'флот не в бою',
  'err.not-inhabited': 'мир необитаем — столицы тут не быть',
  'err.not-owned': 'этого корпуса или модуля нет в вашем арсенале',
  'err.not-paused': 'эта стройка не приостановлена',
  'err.nothing-to-repair': 'корпуса целы — чинить нечего',
  'err.order-limit': 'достигнут предел открытых лотов',
  ...
  'err.own-order': 'это ваш собственный лот',
  'err.own-planet': 'это ваш собственный мир',
  'err.port-damaged': 'космопорт повреждён',
  'err.requires': 'сначала изучите предыдущий узел',
  'err.same-fleet': 'это один и тот же флот',
  'err.same-stance': 'отношения уже такие',
  'err.seat-claimed': 'место уже заявлено',
  'err.seat-seated': 'место уже закреплено',
  'err.seat-unclaimed': 'место не заявлено',
  'err.split-all': 'хотя бы один корабль обязан остаться',
  'err.split-empty': 'нечего отделять',
  'err.stale-construction': 'здание уже изменилось — улучшение устарело',
  'err.steward-locked': 'Хранитель ещё не изучен',
  'err.too-late': 'исследование уже заканчивается — резать нечего',
  'err.too-many-scientists': 'в совете слишком много учёных',
  'err.two-heroes': 'в одном флоте не бывает двух героев',
  ...
  'err.unknown-boon': 'такого усиления в экспедиции нет',
  'err.unknown-building': 'неизвестное здание',
  'err.unknown-faction': 'неизвестная фракция',
  'err.unknown-player': 'вас нет среди мест этой партии',
  'err.unknown-provider': 'Неизвестный провайдер.',
  'err.unknown-resource': 'этим ресурсом не торгуют',
  'err.unknown-scientist': 'неизвестный учёный',
  ...
  'data.evac-transport': 'транспорт с беженцами',
  ...
  'hero.passive.swarm-instinct.desc': 'Флоты Роя в радиусе 42 от Левиафана летят на 10% быстрее.',
  'hero.passive.wreck-optics.desc': "+3% к доле трофеев в боях, где дрался этот герой.",
  'data.field-lab': 'Полевая лаборатория',
  'data.ballistic-model': 'Баллистический расчёт',
  'hero.passive.ballistic-model.desc': 'В слоте: +10% к урону флота героя.',
  'hero.passive.field-lab.desc': '+10% к доле трофеев в боях, где дрался этот герой.',
  ...
  "hero.person.ravager.name": "Лира Сейн",
  "hero.person.ravager.bio": "Пережила разрушение исследовательской станции, где впервые проявился её псионический дар. После катастрофы изучала пределы собственного воздействия на пространство. Говорит мало, действует решительно и строже всех контролирует себя. Для неё мощь оправданна лишь тогда, когда удар завершает бой, а не продлевает его.",
  "hero.person.vanguard.name": "Дариан Кросс",
  "hero.person.vanguard.bio": "Начинал командиром эскорта на опасных торговых маршрутах. После тяжёлого ранения вернулся на мостик с имплантами связи и обработки тактических данных. Привык первым проверять опасный маршрут и лично вести подкрепления. Прямолинеен, быстро принимает решения и ценит инициативу экипажа.",
  "hero.person.warden.name": "Элена Мор",
  "hero.person.warden.bio": "Много лет сопровождала эвакуационные конвои на окраинах освоенного космоса. Псионическую дисциплину развивала ради защиты людей, а не превосходства над ними. Спокойна даже под огнём, помнит цену каждого приказа. Её корабль уходит последним, когда остальные уже на безопасном курсе.",
  "hero.person.scientist.bio": "Автор программы, из которой вырос Рой. Его эвакуировали из комплекса в первые часы карантина — травмированным, но способным работать. Командование ему до конца не доверяет, однако поручило остановить Рой: исходные принципы системы знает только он. Для него это не приказ, а долг перед теми, кого не успели спасти.",
  "hero.person.main.bio": "Вы — командир этого флагмана. Его позывной совпадает с вашим именем в партии. Вашу историю определяют принятые решения: кого защитить, где рискнуть и когда отступить. Способности, изученные навыки и оснащение корабля показаны в этой карточке.",
  "hero.person.dossier": "Личное досье",
  "hero.person.archetype": "Специализация",
  "hero.person.grade": "Редкость",
  "hero.person.ships": "Кораблей во флоте",
  "hero.person.reserve": "Флагман в резерве",
  'hero.person.ship-stats': 'Характеристики флагмана с модулями',
  ...
  'hero.ability.hive-call.desc': '+15% к урону флотов Роя в радиусе 220 от Левиафана, на 2 часа.',
  'hero.ability.devour.desc':
    'Мир под бомбардировкой Левиафана через 4 часа становится мёртвым. Бой с его флотом или уход с орбиты срывают осаду.',
  ...
  'hero.unit.leviathan.desc':
    'Босс матёрого Роя: живой флагман, 900 корпуса и 240 хитина, который нарастает между боями. Приходит с последней волной; гибель окончательна.',
  'hero.unit.ravager.desc': 'Псионик-разрушитель: аннигилирует миры и вскрывает туман.',
  'hero.unit.scientist.desc':
    'Аналитик: вскрывает туман разведкой. Врождённое — «Полевая лаборатория»: +10% к доле трофеев в боях героя.',
  ...
  'solo.save.continue': 'Продолжить одиночную партию',
  'solo.save.play': '▶ Продолжить',
  'solo.save.action': 'Сохранить партию',
  'solo.save.saved': 'Партия сохранена на этом устройстве.',
  'solo.save.failed': 'Не удалось сохранить партию. Проверьте доступ к хранилищу и свободное место.',
  'solo.save.invalid': 'Сохранение повреждено или несовместимо с этой версией игры. Оно не удалено.',
  'solo.save.restored': 'Партия восстановлена на паузе. Нажмите ▶, чтобы продолжить.',
  'solo.save.info': 'Автосохранение каждые 15 секунд и при выходе. Один слот на этом устройстве.',
  'solo.save.replace.title': 'Заменить сохранённую партию?',
  'solo.save.replace.body': 'Новая одиночная партия заменит предыдущее сохранение. Экспедиция Sector Zero хранится отдельно.',
  'solo.save.replace.confirm': 'Начать новую партию',
  'solo.save.replace.cancel': 'Назад',
  ...
  'rescard.supply': 'Снабжение',
  'rescard.supply.buy': 'Купить за {price} ◆',
  'rescard.supply.left': 'Осталось {n} из {m} на экспедицию',
  'rescard.supply.none': 'Снабжение на эту экспедицию исчерпано',
  'rescard.supply.poor': 'Нужно {price} ◆ — Суверенов не хватает',
  'rescard.supply.done': 'Снабжение доставлено.',
  ...
  'log.fleet.launched': '🚀 {who} поднял флот · {at}',
  ...
  'onb.intro.constructor.body':
    'Здесь вы собираете корабли, шаттлы, дивизии и героев из модулей. Лоадаут фиксируется при постройке — выбирайте слоты заранее, переоснастить готовое нельзя. Вкладка «Герои» — штаб командиров.',
  ...
  'onb.intro.tech.body':
    'Здесь вы открываете технологии — постоянные улучшения флота, экономики и обороны. Узел стоит ресурсов и времени; изучил — бонус действует до конца игры. Планируйте ветку под свой стиль игры.',
  ...
  'onb.tour.stage': 'Этап {k} из {n}: {title}',
  'onb.tour.skip-stage': 'Пропустить этап',
  'onb.tour.collapse': 'Свернуть',
  'onb.tour.reopen': '💡 Подсказка',
  ...
  'rail.constructor.title': 'Конструктор — оснащение кораблей, шаттлов, армии и героев',
  ...
  'setup.pve.started': 'Экспедиция начата — Рой уже идёт.',
  'setup.pve.difficulty.weak': 'Рой: обычный',
  'setup.pve.difficulty.strong': 'Рой: матёрый',
  'setup.pve.restored': 'Экспедиция восстановлена — продолжаем с того же места.',
  'setup.pve.restored-portable': 'Экспедиция восстановлена с волны {n}: флоты и ресурсы — заново.',
  ...
  'sector-zero.cancel': 'Сохранить текущую экспедицию',
  'sector-zero.confirm': 'Начать заново',
  'sector-zero.confirm.body': 'Текущая экспедиция будет заменена. Продолжить с этого места уже не получится.',
  'sector-zero.confirm.title': 'Начать новую экспедицию?',
  'sector-zero.cloud.adopted': 'Прогресс загружен из облака',
  'sector-zero.cloud.choice.title': 'В облаке другой прогресс',
  'sector-zero.cloud.choice.body': 'Оставьте один профиль — второй будет заменён.',
  'sector-zero.cloud.here': 'На этом устройстве',
  'sector-zero.cloud.cloud': 'В облаке',
  'sector-zero.cloud.numbers':
    'Экспедиций: {runs} · глав: {chapters} · данных: {research} · {warrants} ⌖ · {sovereigns} ◆',
  'sector-zero.cloud.keep-here': 'Оставить этот',
  'sector-zero.cloud.take-cloud': 'Взять из облака',
  'sector-zero.signin': 'Войти',
  'sector-zero.signin.why': 'Сохранение в облаке и игра с других устройств.',
  'sector-zero.codex.open': 'Досье Роя',
  'sector-zero.codex.eyebrow': 'Разведка прошлых экспедиций',
  'sector-zero.codex.progress': 'Изучено: {n} из {m}',
  'sector-zero.codex.units': 'Формы',
  'sector-zero.codex.modules': 'Органы',
  'sector-zero.codex.buildings': 'Постройки',
  'sector-zero.codex.unknown': 'Не встречено',
  'sector-zero.codex.unit.seen': 'До {n} в отряде · экспедиций: {r}',
  'sector-zero.codex.veil.seen': 'Отразило ваших ударов: {n}',
  'sector-zero.codex.brood.seen': 'Выводит десант: вы видели высадку',
  'sector-zero.codex.building.seen': 'Видели на мирах Роя',
  'sector-zero.codex.empty': 'Пока пусто. Опознайте силы Роя в экспедиции — досье запомнит их после итогов.',
  'sector-zero.continue': 'Продолжить',
  'sector-zero.difficulty': 'Сложность новой экспедиции',
  'sector-zero.difficulty.about.strong':
    'Матёрый Рой думает: изучает технологии, отступает из проигранных боёв, делит флот на две цели, высаживает десант на защищённые миры, пускает челноки и растит героев. С последней волной приходит Левиафан — босс Роя.',
  'sector-zero.difficulty.about.weak':
    'Обычный Рой берёт числом: флоты идут к ближайшей цели и дерутся до конца, технологий он не изучает и десант на защищённые миры не высаживает. В главе I у вас на старте +3 крейсера, гарнизон дома — 6 вместо 9.',
  'sector-zero.difficulty.hint': 'Сложность сохранённой экспедиции остаётся прежней.',
  'sector-zero.difficulty.same': 'Волны по расписанию на обоих уровнях одни и те же.',
  'sector-zero.end.kills': 'Уничтожено врагов: {n}',
  ...
  'sector-zero.end.blueprint': 'Чертёж: {r}',
  ...
  'sector-zero.shop.tokens': '{name}: жетонов ×{n}',
  'sector-zero.shop.tokens.max': 'Звёзды героя на максимуме',
  'sector-zero.shop.tokens.locked': 'Герой придёт наградой за главу',
  'sector-zero.end.unlocked': 'К следующему заходу откроется новых задач: {n}',
  'sector-zero.end.veterans': 'Медали сохранённых ветеранов',
  'boss.leviathan.slain': 'Левиафан повержен',
  'boss.leviathan.spawned': 'Из улья вышел Левиафан — босс Роя',
  'boss.leviathan.task': 'Убить Левиафана',
  'boss.leviathan.siege': '⚠ {world}: Левиафан поглощает мир — гибель через {in}',
  'boss.leviathan.siege-broken': '{world}: осада Левиафана сорвана',
  'boss.leviathan.devoured': '☠ {world}: мир поглощён Левиафаном',
  'sector-zero.end.victory': 'Победа',
  'sector-zero.end.waves': 'Экспедиция: волн {n} из {m}',
  ...
  'sector-zero.forge.poor': 'Не хватает Варрантов',
  'sector-zero.forge.price': 'Улучшить · {n} ⌖',
  'sector-zero.forge.shards': 'Осколки: {n} из {cap}',
  'sector-zero.forge.stars': 'Звёзд: {n} из {cap}',
  'sector-zero.forge.title': 'Улучшение ★',
  'sector-zero.forge.sure': 'Накоплено — следующая попытка удастся точно.',
  'sector-zero.forge.warrants': 'Варранты: {n} ⌖',
  'sector-zero.forge.won': 'Улучшено. Звёзд: {n}.',
  'sector-zero.intro': 'Расширяйте владения. Укрепляйте флот. Выдержите натиск Роя.',
  'sector-zero.loading': 'Проверяем сохранение…',
  'sector-zero.map.close': 'Закрыть карту',
  'sector-zero.map.fog': 'Не разведано',
  'sector-zero.map.hostile': 'Противник',
  'sector-zero.map.lost': 'Связи с районом нет — карта недоступна',
  ...
  'sector-zero.mission.1.brief': 'Пограничный район: первый контакт с Роем.',
  'sector-zero.mission.2.brief': 'Кладбище экспедиции, занятое Роем.',
  'sector-zero.mission.3': 'III · Карантинный рубеж',
  'sector-zero.mission.3.brief': 'Три перехода через карантинный рубеж. Удержать их и не остаться без резерва.',
  'sector-zero.mission.lost': 'Сигнал потерян',
  'sector-zero.mission.lost.brief': 'Связи с этим районом нет. Глава ещё закрыта.',
  'sector-zero.prep': 'Подготовка к экспедиции',
  'sector-zero.training': 'Обучение',
  'sector-zero.training.hint': 'Протокол допуска: учебная симуляция перед главой I',
  'training.started': 'Симуляция активна. Задача — восстановить контроль над учебным районом. Потери кораблей виртуальные. Ваши решения — нет.',
  'training.goal': 'Цель: взять передовой пост и планету-цель учебного противника',
  'training.missions.hint': 'Дополнительные задачи: победу не определяют.',
  'training.end.none': 'Симуляция: опыт и награды профиля не начисляются',
  'training.end.again': 'Повторить обучение',
  'training.stage.prep': 'Подготовка',
  'training.stage.economy': 'База и экономика',
  'training.stage.research': 'Исследование',
  'training.stage.expand': 'Расширение',
  'training.stage.missions': 'Задания',
  ...
  'training.tour.prep.fleet': 'Тапните свой флот у базы: в карточке — состав и приказы. Флот героя экспедиции тоже здесь.',
  'training.tour.economy.mine': 'Постройте на базе Металлодобычу: 80 металла, 3 ч. Этап засчитается, когда стройка завершится.',
  'training.tour.economy.ship': 'Закажите крейсер на вкладке «Корабли» базы: 3 ч. Готовый корабль сам встанет на орбиту.',
  ...
  'training.tour.fortify.build': 'Постройте на посту Форт и Орбитальное ПКО; гарнизон оставьте на месте.',
  'training.tour.finale.target': 'Возьмите планету-цель: форт, ПКО и 2 фрегата. Нужны все крейсеры в одном флоте и 8 тяжёлой пехоты из казарм.',
  ...
  'sector-zero.prep.hero-level': 'Звёзды {n}★ · слотов навыков: {slots}',
  'sector-zero.prep.hero-max': 'Все слоты навыков открыты',
  'sector-zero.prep.hero-select': 'Взять в экспедицию',
  'sector-zero.prep.hero-selected': 'В следующей экспедиции',
  'sector-zero.prep.hero-ship': 'Корабль героя',
  'sector-zero.prep.hero-ship.hint': 'Летит в экспедицию с выбранным героем. Звезда героя — +1 слот модуля.',
  'sector-zero.prep.hero-ship.off-run': 'В экспедицию летит корабль выбранного героя — выбор в Академии.',
  'sector-zero.prep.hero-ships': 'Корабли героев',
  'sector-zero.prep.hero-ship.next': 'Звезда {n}★: +1 слот — {slot}.',
  'sector-zero.prep.hero-upgrade': 'Звезда {star}★: +1 слот навыка и корабля · жетонов {n}',
  'sector-zero.prep.heroes': 'Академия',
  'sector-zero.prep.hint': 'Выбор сохраняется для следующей попытки. Текущая экспедиция не меняется.',
  'sector-zero.prep.modules': 'Корабли',
  'sector-zero.prep.owned': 'Открыто',
  'sector-zero.prep.research': 'Данные экспедиций: {n}',
  'sector-zero.prep.reward': 'Последняя экспедиция: +{n} данных',
  'sector-zero.prep.saved': 'Подготовка сохранена',
  'sector-zero.prep.ship-hint': 'Стартовые корабли получат этот сет. На верфи он будет выбран по умолчанию.',
  'sector-zero.prep.shop': 'Магазин',
  'sector-zero.prep.skill-buy': 'Изучить · {n} данных',
  'sector-zero.prep.skill-hint': 'Открывайте связанные узлы: они дают новые способности и усиливают их эффекты.',
  'sector-zero.prep.unavailable': 'Не хватает данных или не выполнены условия.',
  'sector-zero.prep.unlock': 'Открыть · {n} данных',
  'sector-zero.prep.warrants': '+{n} ⌖',
  'sector-zero.restore-failed': 'Не удалось открыть сохранение. Можно начать новую экспедицию.',
  'sector-zero.tab-taken.title': 'Sector Zero открыт в другой вкладке',
  'sector-zero.tab-taken.text': 'Прогресс сохраняет та вкладка. Здесь игра остановлена, чтобы две вкладки не затирали друг друга.',
  'sector-zero.tab-taken.here': 'Играть здесь',
  'sector-zero.route.core': 'Эпицентр',
  'sector-zero.route.edge': 'Край сектора',
  'sector-zero.saved': 'Экспедиция в процессе',
  ...
  'sector-zero.comic.title': 'Комикс главы',
  'sector-zero.comic.skip': 'Пропустить',
  ...
  'side.fleet.ambush': '⟟ засада на развилке {planet} · ловит всех на тропе → {exits}',
  ...
  'side.garrison.ships': 'Корабли на планете',
  ...
  'side.wing.conveyor': 'Конвейер шаттлов',
  'side.wing.garrison.hint':
    'Эскадра стоит в ангаре порта, на карте её нет. «{b}» поднимает вылет — цель выберите тапом по карте. Корабль с трюмом возит эскадру с собой: трюм — в панели флота.',
  ...
  'side.world.count.shuttles': 'шаттлов',
  ...
  'swarm.journal.title': 'Как Рой приспосабливается',
  'swarm.journal.tier.fact': 'Факт',
  ...
  'swarm.journal.stale': 'отрядов Роя без прежнего перехвата: {n} — похоже, отрезаны от сети и воюют по старой памяти',
  'swarm.intel.network': 'Опыт боёв Рой передаёт только по связи: центры данных и ретрансляторы. Отрезанная часть воюет по старой памяти, пока связь не вернётся.',
  ...
  'tech.node.void-shipworks.desc':
    'Причальная палуба, топливные цистерны и ремонтные леса прямо на теле крепости. Открывает её собственный ангар — шаттлам больше не нужен наземный космопорт.',
  ...
  'tech.node.strike-vectors.desc': 'Ударные векторы: расчёт заходов шаттлов. +8% к урону.',
