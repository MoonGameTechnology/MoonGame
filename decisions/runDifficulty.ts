 ...
 * (`AiProfile` в `prototype/src/ai.ts`), а матёрый Рой ещё и выводит с последней волной
 * Левиафана — босса с наградой за гибель (PVR-4.7). Волны по расписанию у обоих одни.
