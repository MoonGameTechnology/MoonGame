...
export const ru: Record<string, string> = {
  ...
  'build.fx.hangar': 'ангар: {n} мест под челноки',
  ...
  'side.wing.blocked.busy': 'носитель в бою — звеньям не до вылета',
  ...
  'data.duel': 'Дуэль',
  'data.run-boon-barrage': 'Огневой вал',
  'data.run-boon-engines': 'Форсаж',
  'data.run-boon-foundry': 'Литейный аврал',
  'data.run-boon-gunnery': 'Слаженный залп',
  'data.run-boon-logistics': 'Снабжение фронта',
  'data.run-boon-sensors': 'Глубокое сканирование',
  ...
  'dossier.building.starfort':
    'Корпус космической крепости — то, чем узел держится и отбивается. {hp} прочности, {aa} по кораблям и {pd} по челнокам, {d} к обороне земли. Растёт с уровнем крепости; отдельно его не строят — он приходит вместе с ней.',
  ...
  'err.no-port': 'нужен космопорт — челноки живут в его ангаре',
  ...
  'tech.node.boon-barrage.desc': 'Усиление забега: +10% к урону и +10% к скорости флотов.',
  'tech.node.boon-engines.desc': 'Усиление забега: +20% к скорости флотов.',
  'tech.node.boon-foundry.desc': 'Усиление забега: +25% к производству.',
  'tech.node.boon-gunnery.desc': 'Усиление забега: +15% к урону.',
  'tech.node.boon-logistics.desc': 'Усиление забега: +10% к производству и +20% к радиусу радаров.',
  'tech.node.boon-sensors.desc': 'Усиление забега: +40% к радиусу радаров.',
