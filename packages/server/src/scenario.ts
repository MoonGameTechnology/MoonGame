...
// меняет правила и им: остановка на дороге берёт пустую провинцию, а бой на дороге больше
// не втягивает стоящих у мира. Оба кирпича едут под одним номером — 28 ещё не выпущен.
