...
export const ru: Record<string, string> = {
  ...
  'swarm.intel.live': 'В поле видимости',
  'swarm.intel.stale': 'Последнее наблюдение — состав мог измениться',
  'swarm.intel.contact': 'Контакт {id} · {location}',
  'swarm.intel.time': 'День {day}, {time}',
