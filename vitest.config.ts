...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      // Шипнутый каталог для браузерных потребителей — та же схема, что у локализации:
      // модуль общий на прототип и клиент, поэтому живёт рядом с данными (data/bundle.ts).
      'data/**/*.test.ts',
