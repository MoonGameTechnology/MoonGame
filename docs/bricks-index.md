...
| SZE-3.1 | ✅ | data proto | `docs/sector-zero-economy-roadmap.md:388` | Витрина и три способа оплаты |
| SZE-3.2 | ⏳ | data | `docs/sector-zero-economy-roadmap.md:430` | Ассортимент |
| SZE-3.3 | ⏳ | docs sec | `docs/sector-zero-economy-roadmap.md:439` | Покупки в Sector Zero и площадка |
| SZE-4.1 | ⏳ | data | `docs/sector-zero-economy-roadmap.md:448` | Уровень у адаптации |
| SZE-4.2 | 🔒 | core | `docs/sector-zero-economy-roadmap.md:454` | Контригра против уровня |
