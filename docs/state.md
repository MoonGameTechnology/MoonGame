...
- **UI — тактический пульт (DEFCON-вайб):** векторно-каркасный стиль на чёрном.
  ...
  - **Опциональная флагманская консоль на ПК и планшетах:** переключатель в настройках
    ...
    получают стеклянную оболочку. Выбор провинции/флота открывает полное досье справа.
    Командное окно выделено более яркой рамкой; вспомогательные подписи контрастнее.
    ...
    Все настоящие команды выбранного флота обёрнуты в окно рядом с его маркером:
    размещение учитывает края и досье; при наведении мыши/клавиатурном фокусе окно
    удерживается на месте, чтобы кнопки не уезжали во время нажатия. Длинное меню
    прокручивается, режим цепочки использует свой прежний набор действий.
