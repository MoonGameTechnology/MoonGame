...
- **UI — тактический пульт (DEFCON-вайб):** векторно-каркасный стиль на чёрном.
  ...
  - **Опциональная флагманская консоль на ПК и планшетах:** переключатель в настройках
    ...
    **Космическая местность** вместо парящих бейджей типа получает векторный узор
    ...
    Глубину карты передают второй световой край, координатная сетка и деления
    в плоскости мира; космический фон приглушён. Простой режим и телефонная
    раскладка сохранены.
    ...
    **Нестабильная кромка:** сама граница `drawGlassRim` — непрерывная холодная
    ...
    центр. Геометрия, скругления и толщина масштабируются вместе с картой;
