...
export const ru: Record<string, string> = {
  ...
  'sector-zero.rarity.top': 'Высшая редкость',
  ...
  'sector-zero.forge.empty': 'Сначала откройте модули во вкладке кораблей.',
  'sector-zero.forge.has': 'Сейчас',
  'sector-zero.forge.hint': 'Звезда усиливает сам модуль. Попытка тратит Варранты и может не удаться.',
  ...
  'sector-zero.prep.fits-only': 'Только для: {list}',
