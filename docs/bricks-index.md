...
| HEROART-1 | ✅ | proto cli | `docs/backlog.md:14455` | Портреты, досье и читаемый счёт флота |
| YARD-1 | ✅ | data proto srv | `docs/backlog.md:14565` | Корабли строит ВЕРФЬ, челноки — |
| YARD-2 | ✅ | data | `docs/backlog.md:14599` | У верфи два яруса: дешёвый строит, дорогой |
| CMB-7 | ✅ | core | `docs/backlog.md:14623` | Перемирие посреди боя не останавливало бой. |
| RLY-1 | ✅ | proto | `docs/backlog.md:14644` | Сбор построенного: соло и сеть играли по РАЗНЫМ |
| CARGO-1 | ✅ | core proto | `docs/backlog.md:14676` | Часовая погрузка десанта жила в |
| MRG-1 | ✅ | core proto | `docs/backlog.md:14724` | «Слиться по прибытии» — вторая половина |
| ART-0 | ✅ | core data proto | `docs/backlog.md:14747` | Артиллерия снята из игры целиком |
| ORB-1 | ✅ | core data proto | `docs/backlog.md:14778` | Орбитальный слой объявлен в |
| ORB-4 | ✅ | core data proto | `docs/backlog.md:14814` | в астероидном поле строилось всё, что угодно: |
| ORB-2 | ✅ | data proto | `docs/backlog.md:14855` | «Изучается технология, строится здание» не |
| ORB-3 | ✅ | proto | `docs/backlog.md:14883` | Звёздный форт выдавал орбитальное ПКО мимо |
| CMB-6 | ✅ | core | `docs/backlog.md:14920` | После ничьей третий враждебный флот получает свой |
| ORD-2 | ✅ | proto | `docs/backlog.md:14950` | Нацеленный ШТУРМ теперь переживает закрытую |
...
| FORT-0.1 | 🗑 | data | `docs/fortress-roadmap.md:404` | Узлы empty в картах канона — снято 2026-09-15 |
| FORT-0.2 | ✅ | core proto | `docs/fortress-roadmap.md:419` | Крепость в прототипе: модуль, правило, кнопка |
| FORT-1.1 | 🗑 |  | `docs/fortress-roadmap.md:454` | Технический юнит + технология — снято 2026-09-15 |
| FORT-1.2 | 🗑 |  | `docs/fortress-roadmap.md:469` | Конверсия расходует техюнит — снято 2026-09-15 |
| FORT-1.3 | 🗑 |  | `docs/fortress-roadmap.md:483` | Вкладка технических юнитов в «Верфи» — снято 2026-09-15 |
| FORT-1.4 | ✅ | proto | `docs/fortress-roadmap.md:495` | Недостающие ключи отказов |
| FORT-2.1 | ✅ | data | `docs/fortress-roadmap.md:517` | Юнит «Гарнизон» |
| FORT-2.2 | ✅ | core data | `docs/fortress-roadmap.md:535` | Форт выдаёт и забирает гарнизон |
| FORT-2.3 | ✅ | data core | `docs/fortress-roadmap.md:554` | Потолок гарнизона и фракционный модификатор |
| FORT-3.1 | ✅ | data | `docs/fortress-roadmap.md:573` | Уровни зенитных батарей |
| FORT-3.2 | ✅ |  | `docs/fortress-roadmap.md:586` | Выполнен ЧУЖОЙ работой; остаток снят как противоречащий более позднему решению |
| FORT-4.1 | ✅ | core data | `docs/fortress-roadmap.md:613` | Какие ещё узлы конвертируются |
| FORT-5.1 | ✅ | data core | `docs/fortress-roadmap.md:637` | Технологию крепости надо ИЗУЧИТЬ |
| FORT-5.2 | ✅ | data core | `docs/fortress-roadmap.md:667` | Ядро крепости: starfort дорос до пяти уровней |
| FORT-5.3 | ✅ | core data | `docs/fortress-roadmap.md:713` | Слоты построек |
| FORT-5.4 | ✅ | core data | `docs/fortress-roadmap.md:740` | Крепость ВСТУПАЕТ В БОЙ |
| FORT-5.12 | ✅ | core data | `docs/fortress-roadmap.md:792` | Крепость под ударом: не обстреливают, и бой глушит работу |
| FORT-5.5 | ✅ | data core | `docs/fortress-roadmap.md:826` | Класс корпуса у кораблей |
| FORT-5.6 | ✅ | data | `docs/fortress-roadmap.md:862` | Верфь крепости: три уровня |
| FORT-5.7 | ✅ | data core | `docs/fortress-roadmap.md:872` | Ангар крепости |
| FORT-5.8 | ✅ | core | `docs/fortress-roadmap.md:893` | Док чинит СОЮЗНИКУ |
| FORT-5.9 | ✅ | core data | `docs/fortress-roadmap.md:917` | Госпиталь лечит ТРЮМ |
| FORT-5.10 | ✅ | core data | `docs/fortress-roadmap.md:936` | Щиты крепости |
| FORT-5.11 | ✅ | data | `docs/fortress-roadmap.md:978` | Технологии открывают постройки крепости |
| FORT-5.13 | ✅ | core | `docs/fortress-roadmap.md:1007` | Сбитая крепость уничтожается |
...
| PVR-0.4 | ✅ | data | `docs/sector-zero-roadmap.md:1348` | Карта — развилки из линий |
| PVR-1.1 | ✅ | proto core data cli | `docs/sector-zero-roadmap.md:1405` | Соло-запуск задаёт modeId |
| PVR-1.2 | ✅ | proto | `docs/sector-zero-roadmap.md:1447` | HUD забега: волна N из M и время до следующей |
| PVR-1.3 | ✅ | data | `docs/sector-zero-roadmap.md:1479` | Состав волны перестаёт быть одним дроном |
| PVR-1.4 | ✅ | proto core | `docs/sector-zero-roadmap.md:1540` | Выбор между волнами |
| PVR-1.5 | ✅ | core | `docs/sector-zero-roadmap.md:1597` | Волны Роя враждебны и доходят до боя |
| PVR-1.6 | ✅ | core data | `docs/sector-zero-roadmap.md:1636` | Забег доходит до вердикта |
| PVR-1.7 | ✅ | core data proto | `docs/sector-zero-roadmap.md:1705` | Пиратская база для первого боя |
| PVR-2.1 | ✅ | proto | `docs/sector-zero-roadmap.md:1735` | Выбор сложности на запуске забега |
| PVR-2.2 | ✅ | proto | `docs/sector-zero-roadmap.md:1771` | У забега свой темп и ускорение |
| PVR-3.1 | ⏳ | docs | `docs/sector-zero-roadmap.md:1814` | Резолюция: чем PvE-прокачка НЕ является |
| PVR-3.2 | ✅ | proto | `docs/sector-zero-roadmap.md:1826` | Хранилище PvE-прогресса |
| PVR-3.3 | ✅ | proto | `docs/sector-zero-roadmap.md:1838` | Награда за забег |
| PVR-4.1 | ✅ | docs | `docs/sector-zero-roadmap.md:1863` | Резолюция: что из §3 входит в первую версию |
| PVR-4.2 | ✅ | core | `docs/sector-zero-roadmap.md:1881` | Память Роя как состояние |
| PVR-4.3 | ✅ | core data | `docs/sector-zero-roadmap.md:1918` | Одна читаемая адаптация от сигнала до формы |
| PVR-4.4 | ✅ | data | `docs/sector-zero-roadmap.md:1960` | Структуры первого набора |
| PVR-4.5 | ✅ | proto | `docs/sector-zero-roadmap.md:1990` | Журнал адаптаций |
