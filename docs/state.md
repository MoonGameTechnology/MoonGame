...
> **Гейт:** `pnpm run check` (lint + typecheck + test + docs-check). **Тесты: 3904 зелёных** (58 skip, 306 файлов).
...
Итого **1679 ключей**. Записи в локалях разложены по доменным секциям и отсортированы
