...
> **Гейт:** `pnpm run check` (lint + typecheck + test + docs-check). **Тесты: 5107 зелёных** (58 skip, 389 файлов).
...
мёртвого контента 21 → 8 позиций). Вне охвата осталось то, чего ещё нет в самой игре:
