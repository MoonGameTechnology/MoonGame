...
| FORT-5.9 | ⏳ | core data | `docs/fortress-roadmap.md:795` | Больница лечит ТРЮМ |
| FORT-5.10 | ⏳ | core data | `docs/fortress-roadmap.md:805` | Щиты крепости |
| FORT-5.11 | ⏳ | data | `docs/fortress-roadmap.md:814` | Технологии открывают постройки крепости |
