...
export const ru: Record<string, string> = {
  ...
  'hud.missions.title': 'Задачи забега',
  'hud.missions.hint': 'Награда приходит на итогах забега.',
  ...
  'pve.pirates.won': 'База взята, первый бой завершён. Проверьте потери своего флота и готовьте оборону против Роя. Победа в забеге ещё впереди.',
  'pve.pirates.cleared': 'Пиратская цель уже зачищена. Продолжайте подготовку к волнам Роя.',
  'pve.pirates.recover': 'Сейчас у вас нет боевого флота. Пополните силы на домашней верфи или оставьте пиратов на потом. Забег продолжается.',
  'pve.pirates.show': 'Показать базу',
  'pve.pirates.open-battle': 'Открыть сражение',
  'pve.pirates.continue': 'Продолжить забег',
  ...
  'err.supply-exhausted': 'снабжение на этот забег исчерпано',
  ...
  'err.unknown-boon': 'такого усиления в забеге нет',
  ...
  'solo.save.replace.body': 'Новая одиночная партия заменит предыдущее сохранение. Забег Sector Zero хранится отдельно.',
  ...
  'rescard.supply.left': 'Осталось {n} из {m} на забег',
  'rescard.supply.none': 'Снабжение на этот забег исчерпано',
  ...
  'sector-zero.cloud.numbers':
    'Забегов: {runs} · глав: {chapters} · данных: {research} · {warrants} ⌖ · {sovereigns} ◆',
  ...
  'sector-zero.codex.eyebrow': 'Разведка прошлых забегов',
  'sector-zero.codex.close': 'Закрыть досье',
  ...
  'sector-zero.codex.unit.seen': 'До {n} в отряде · забегов: {r}',
  ...
  'sector-zero.codex.empty': 'Пока пусто. Опознайте силы Роя в забеге — досье запомнит их после итогов.',
  ...
  'sector-zero.end.waves': 'Забег: волн {n} из {m}',
  ...
  'sector-zero.map.target': 'Задача забега',
