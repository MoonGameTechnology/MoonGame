...
export const ru: Record<string, string> = {
  ...
  'dossier.unit.artillery.desc':
    'Дальнобойная батарея: бьёт на {r} по одной цели, не входя в бой и не получая ответного огня. Взамен — стеклянная ({hp} корпуса) и медленная. Стоит в собственной, АРТИЛЛЕРИЙСКОЙ линии: пока перед ней есть хоть один корабль, на неё приходится лишь десятая часть залпа, но останется она одна — и примет всё.',
