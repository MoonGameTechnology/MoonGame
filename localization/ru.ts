...
export const ru: Record<string, string> = {
  ...
  'data.landing-shuttle': 'десантный шаттл',
  'donate.aria': 'Суверены: {n}. Пополнить',
  'donate.soon': 'Магазин Суверенов — скоро',
  'dossier.unit.landing-shuttle.desc': 'Десантный шаттл: безоружный борт с трюмом на {c} — он не бьёт по кораблям вовсе, отказ приходит прямо на приказе. Летит один раз: садится вместе с грузом и обратно не возвращается. Пустой чужой мир берёт сразу, обороняемый — высаживает ПЛАЦДАРМ и завязывает наземный бой без единого корабля рядом; на свой мир возит подкрепление. Зональное ПВО режет и машины, и то, что они везли ({hp} корпуса, радиус {r}).',
  'dossier.unit.landing-shuttle.name': 'Десантный шаттл',
  ...
  'dossier.unit.bomber.desc':
    'Бомбардировщик: шаттл против КОРПУСОВ — {a} урона по кораблю, вдвое тяжелее перехватчика. По постройкам работает средне ({s} в час): мир он потреплет, но сносить его — дело осадных платформ. Тяжелее и медленнее перехватчика ({hp} корпуса, радиус {r}), дольше перезаряжается, в бой не вступает: подлетел, ударил, ушёл домой.',
