...
- **UI — тактический пульт (DEFCON-вайб):** векторно-каркасный стиль на чёрном.
  - **Карта = голографическая проекция:** исходные координаты, размеры провинций и
    ...
    не менялась. CSS-сканлинии сняты; фон, сетка и дороги кэшируются вместе.
  ...
  - **Опциональная флагманская консоль на ПК и планшетах:** переключатель в настройках
    ...
    **Космическая местность** вместо парящих бейджей типа получает векторный узор
    ...
    несколько контурных плоскостей; растровые текстуры местности не используются.
    ...
    Статичная геометрия кэшируется, живой слой ограничен четырьмя короткими бликами.
