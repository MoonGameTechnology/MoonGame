 ...
 *
 * 6. **Мозаика тут ОДНА на всех, кто её строит (REFM-124).** Клетку считает не только
 *    политическая заливка: вспышка захвата пересобирает её каждый кадр, чтобы обрезать
 *    по ней расходящуюся волну. И собирала СВОЕЙ копией формул — `9000 * scale²` и
