...
| SZE-1.3 | ⏳ | proto | `docs/sector-zero-economy-roadmap.md:296` | Осколки и pity |
| SZE-2.1 | 🔒 | proto | `docs/sector-zero-economy-roadmap.md:305` | Экран Академии на движке Мастерской |
| SZE-3.1 | ⏳ | proto | `docs/sector-zero-economy-roadmap.md:316` | Витрина и три способа оплаты |
| SZE-3.2 | 🔒 | data | `docs/sector-zero-economy-roadmap.md:322` | Ассортимент |
| SZE-3.3 | 🔒 | docs sec | `docs/sector-zero-economy-roadmap.md:328` | Покупки в Sector Zero и площадка |
| SZE-4.1 | ⏳ | data | `docs/sector-zero-economy-roadmap.md:337` | Уровень у адаптации |
| SZE-4.2 | 🔒 | core | `docs/sector-zero-economy-roadmap.md:343` | Контригра против уровня |
