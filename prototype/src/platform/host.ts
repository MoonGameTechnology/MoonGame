 ...
 * НЕ ОТВЕТИТЬ (AUD-27: без срока игра так и стояла на экране загрузки, `ready()` площадке
...
/**
 * Сколько ждать `YaGames.init()` после того, как лоадер уже поднялся (AUD-27). Щедро: у
