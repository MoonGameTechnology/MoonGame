...
export const ru: Record<string, string> = {
  ...
  'side.wing.hold': 'Трюм авианосца — {used} из {bay}',
  ...
  'dossier.unit.shuttle-carrier.desc':
    'Плавучий космопорт: {bay} мест под шаттлы, с него они вылетают и на него садятся — значит флот бьёт шаттлами вдали от своих миров. Это КОРАБЛЬ, а не шаттл: стоит в ЗАДНЕЙ линии и держит удар ({d} защиты, {hp} корпуса), хотя своих пушек почти нет ({a} атаки). Заказывается среди кораблей. Ангар живёт ровно столько, сколько живы его корпуса: потеряете авианосец — потеряете и шаттлы на борту.',
