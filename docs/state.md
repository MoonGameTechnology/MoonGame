...
> **Гейт:** `pnpm run check` (lint + typecheck + test + docs-check). **Тесты: 5608 зелёных** (61 skip, 428 файлов).
...
> с базовым списком `prototype/content-parity-baseline.txt` — **213 расхождений** (замер
> 2026-08-27 дал 274; CONV-15 закрыл 13, CONV-17 — ещё 51, CONV-16 — три; HC-3 принёс новый
