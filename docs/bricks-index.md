...
| BLD-1 | ⏳ | core proto | `docs/backlog.md:13390` | Очередь строительства: заказы встают в ряд, а не |
| UI-14 | ⏳ | proto | `docs/backlog.md:13407` | Осмотр чужого флота должен быть находимым. |
