...
// оказалась не в эвристике, а в ГЕЙТЕ: пехоту открывает казарма (сегодня флаг
// `enablesInfantryConstruction`, ROS-1.1), стартовый мир её не получает, поэтому каждый
// заказ пехоты ядро отбивало кодом `E_NO_BARRACKS`. Отказ тихий — харнес просто
