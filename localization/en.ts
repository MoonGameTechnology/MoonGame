...
export const en: Record<string, string> = {
  ...
  'sector-zero.shop.hint': 'Modules, skills, resources and rarity blueprints. A module you already own arrives as a duplicate. Each item is sold by its own payment methods.',
