...
export const ru: Record<string, string> = {
  ...
  'err.no-hangar': 'нужен ангар (аэродром)',
  'err.not-squadron': 'это не эскадрилья (нет базы-носителя)',
  'err.no-base': 'база-носитель не найдена',
  'err.no-range': 'у эскадрильи нет радиуса удара',
  'err.no-speed': 'у эскадрильи нет скорости',
  'err.no-position': 'нет текущей позиции',
  'err.no-target-position': 'у цели нет позиции',
  'err.not-hostile': 'цель — свой юнит',
