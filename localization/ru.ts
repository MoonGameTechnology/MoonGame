...
export const ru: Record<string, string> = {
  ...
  'sector-zero.difficulty.about.strong':
    'Матёрый Рой думает: изучает технологии, отступает из проигранных боёв, делит флот на две цели, высаживает десант на защищённые миры, пускает челноки и растит героев.',
  ...
  'sector-zero.difficulty.same': 'Волны по расписанию и награда на обоих уровнях одни и те же.',
