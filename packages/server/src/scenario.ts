...
export const MODULE_MANIFEST_VERSION = '28'; // ROADS-2: флоты летают по дорогам, мимо планеты — через развилку.
...
// (собранные до ROADS-1) и так играют по прямым — откат по инварианту 3.
