...
| PVR-0.1 | ✅ | data | `docs/sector-zero-roadmap.md:1202` | Карта pve-1 снова строится |
| PVR-0.2 | ✅ | proto | `docs/sector-zero-roadmap.md:1233` | pveModule в ядре прототипа |
| PVR-0.3 | ✅ | proto | `docs/sector-zero-roadmap.md:1260` | Сохранение: сперва мета, потом забег |
| PVR-0.4 | ✅ | data | `docs/sector-zero-roadmap.md:1338` | Карта — развилки из линий |
| PVR-1.1 | ✅ | proto core data cli | `docs/sector-zero-roadmap.md:1395` | Соло-запуск задаёт modeId |
| PVR-1.2 | ✅ | proto | `docs/sector-zero-roadmap.md:1437` | HUD забега: волна N из M и время до следующей |
| PVR-1.3 | ✅ | data | `docs/sector-zero-roadmap.md:1469` | Состав волны перестаёт быть одним дроном |
| PVR-1.4 | ✅ | proto core | `docs/sector-zero-roadmap.md:1530` | Выбор между волнами |
| PVR-1.5 | ✅ | core | `docs/sector-zero-roadmap.md:1587` | Волны Роя враждебны и доходят до боя |
| PVR-1.6 | ✅ | core data | `docs/sector-zero-roadmap.md:1626` | Забег доходит до вердикта |
| PVR-1.7 | ✅ | core data proto | `docs/sector-zero-roadmap.md:1695` | Пиратская база для первого боя |
| PVR-2.1 | ✅ | proto | `docs/sector-zero-roadmap.md:1725` | Выбор сложности на запуске забега |
| PVR-2.2 | ✅ | proto | `docs/sector-zero-roadmap.md:1761` | У забега свой темп и ускорение |
| PVR-3.1 | ⏳ | docs | `docs/sector-zero-roadmap.md:1804` | Резолюция: чем PvE-прокачка НЕ является |
| PVR-3.2 | ✅ | proto | `docs/sector-zero-roadmap.md:1816` | Хранилище PvE-прогресса |
| PVR-3.3 | ✅ | proto | `docs/sector-zero-roadmap.md:1828` | Награда за забег |
| PVR-4.1 | ✅ | docs | `docs/sector-zero-roadmap.md:1853` | Резолюция: что из §3 входит в первую версию |
| PVR-4.2 | ⏳ | core | `docs/sector-zero-roadmap.md:1871` | Память Роя как состояние |
| PVR-4.3 | 🔒 | core data | `docs/sector-zero-roadmap.md:1882` | Одна читаемая адаптация от сигнала до формы |
| PVR-4.4 | ⏳ | data | `docs/sector-zero-roadmap.md:1890` | Структуры первого набора |
| PVR-4.5 | 🔒 | proto | `docs/sector-zero-roadmap.md:1898` | Журнал адаптаций |
