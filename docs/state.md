...
**Первый разбор годным прибором сделан 2026-08-26 и разложен на кирпичи:** что осталось
починить в самом боте — блок AI-BAL (разброс сидов, отступление и осада, герой, рынок,
диагностика мёртвого контента); что нашлось в БАЛАНСЕ ИГРЫ — новый блок **BAL**: старт `C5R1`
даёт +68% очков (у него 10 призовых миров в радиусе 500 против 6 у `C2R1` — перекос ровно
на разницу территории), фракции расходятся на +47% при win-rate 50/50, snowball 100% без
единого камбэка, 91% территории меняет хозяина без выстрела, кредиты копятся до 64k при
нулевых arrears, а дерево технологий работает как очередь по цене. Не сдвинулись ни
