...
export const ru: Record<string, string> = {
  ...
  'dossier.unit.shuttle-carrier.desc':
    'Плавучий космопорт: {bay} мест под челноки, с него они вылетают и на него садятся — значит флот бьёт челноками вдали от своих миров. Своих пушек почти нет ({a} атаки), зато держит удар ({d} защиты, {hp} корпуса) и стоит в ЗАДНЕЙ линии. Ангар живёт ровно столько, сколько живы его корпуса: потеряете носитель — потеряете и челноки на борту.',
