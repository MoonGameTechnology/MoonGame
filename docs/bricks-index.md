...
| CMB-4 | ⏳ | core | `docs/backlog.md:13365` | Первый раунд боя — на самой встрече, а не через игровой час. |
| BLD-1 | ⏳ | core proto | `docs/backlog.md:13377` | Очередь строительства: заказы встают в ряд, а не |
| UI-14 | ⏳ | proto | `docs/backlog.md:13394` | Осмотр чужого флота должен быть находимым. |
