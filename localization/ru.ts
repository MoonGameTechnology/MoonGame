...
export const ru: Record<string, string> = {
  ...
  'sector-zero.prep.hero-level': 'Подготовка {n} · активных навыков: {slots}',
  ...
  'sector-zero.shop.hint': 'Модули, навыки, ресурсы и чертежи редкости. Открытый модуль приходит дублем. Каждый товар продаётся своими способами оплаты.',
