...
export const en: Record<string, string> = {
  ...
  'err.no-hangar': 'needs a hangar bay',
  'err.not-squadron': 'not a squadron (no home base)',
  'err.no-base': 'home base not found',
  'err.no-range': 'squadron has no strike range',
  'err.no-speed': 'squadron has no speed',
  'err.no-position': 'no current position',
  'err.no-target-position': 'target has no position',
  'err.not-hostile': 'target is your own unit',
