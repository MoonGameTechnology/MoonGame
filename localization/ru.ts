...
export const ru: Record<string, string> = {
  ...
  'hero.passive.field-lab.desc': '+5% к доле трофеев в боях, где дрался этот герой.',
  ...
  'hero.unit.scientist.desc':
    'Аналитик: вскрывает туман и ставит ложные сигналы. Врождённое — «Полевая лаборатория»: +5% к доле трофеев в боях героя.',
