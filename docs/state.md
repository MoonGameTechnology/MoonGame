...
> **Гейт:** `pnpm run check` (lint + typecheck + test + docs-check). **Тесты: 5514 зелёных** (60 skip без `DATABASE_URL`, 421 файл).
...
- Что брать в работу → `backlog.md` (кирпичики со статусами и зонами; 1 кирпич ≈ 1 PR).
  ...
  блокировке `🔒(ID)`, чей кирпич уже закрыт (расчистка 2026-09-01 сняла пять ложных замков).
