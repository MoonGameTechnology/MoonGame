...
(захватов прилётом 33975 → 28875, мёртвого контента 21 → 12 позиций). Вне охвата
остаются эскадрильи, носители и герой — `backlog.md`, блок AI-BAL. Не сдвинулись ни
...
показывала, и вторая неделя разделила находки по природе: фора СТАРТА структурная и растущая
(`C5R1` 1548 очков против 877, +76% против +68% за неделю), а перекос ФРАКЦИИ — эффект ранней
игры, он выгорает (+25% за неделю → +10% за две, при win-rate ровно 50/50). Живого игрока это
