...
export const ru: Record<string, string> = {
  ...
  'onb.tour.mine': 'Начни с экономики: улучши Металлодобычу — так вырастет доход металла, на который строится всё остальное.',
  'onb.tour.speed': '⏩ Обучение идёт в ускоренном времени, чтобы не ждать стройку и путь флота вживую.',
  'onb.tour.troops': 'У флота есть трюм для десанта: тапни его на своём мире → «Наземная армия ⇄ гарнизон» → «Погрузить». Открытый мир берёшь одной орбитой, а мир с гарнизоном — только высадкой: сначала флот собьёт оборону сверху, потом десант берёт землю.',
