...
export const ru: Record<string, string> = {
  ...
  // --- cli — PWA-клиент (packages/client): экран приветствия, статусы сети, отказы.
  'cli.engine-ready': 'движок готов · t={t}',
  'cli.err.no-nick': 'Введите позывной.',
  'cli.err.unknown-provider': 'Неизвестный провайдер.',
  'cli.net.closed': '✖ Соединение закрыто',
  'cli.net.connecting': '⇄ Подключение к матчу…',
  'cli.net.online': '● Онлайн · вы {me} · {hint}',
  'cli.net.order': 'Приказ: {fleet} → {to}',
  'cli.net.tap-fleet': 'тапните свой флот',
  'cli.net.tap-target': 'тапните цель',
  'cli.net.waiting': '⏳ Ожидание игроков…',
  'cli.net.you': 'вы {me}',
  'cli.route.browse.back': 'Обзор матчей · {nick}',
  'cli.route.browse.new': 'Обзор матчей · новый командир «{nick}»',
  'cli.route.guest-stub': 'вход через {p} скоро — пока гость',
  'cli.route.returning': 'возвращение',
  'cli.route.single': 'Одиночная игра — запуск песочницы… (движок в браузере)',
  'cli.soon': 'скоро',
  'cli.welcome.imprint': 'Выходные данные',
  'cli.welcome.login': 'Вход по позывному',
  'cli.welcome.privacy': 'Политика конфиденциальности',
  'cli.welcome.sign-in-with': 'войти через',
  ...
  // --- loadout — Редактор оснащения клиента: подписи характеристик.
