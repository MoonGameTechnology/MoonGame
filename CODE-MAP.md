...
| `docs/bricks-index.md` | **генерируемый индекс кирпичей**: ID → статус, зона, файл:строка. Отвечает на «есть ли уже кирпич про X?» одним поиском вместо перебора бэклога |
