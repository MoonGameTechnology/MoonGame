...
export const ru: Record<string, string> = {
  ...
  'log.build.cleared': '🧹 {b}: гарнизон зачистил на {at}',
  ...
  // --- place — имена мест карт из data/maps/ (SZ-map-ids). Ключ строит placeLabel()
  // в /decisions из id сектора: home_a → place.home-a. Сторож — decisions/placeLabel.test.ts.
  'place.home-a': 'Бастион',
  'place.home-b': 'Приют',
  'place.pirate-den': 'Пиратское логово',
  'place.drift': 'Дрейф',
  'place.veil': 'Вуаль',
  'place.cluster': 'Скопление',
  'place.shoal': 'Отмель',
  'place.shear': 'Сдвиг',
  'place.ridge': 'Гребень',
  'place.hive': 'Улей',
  'place.landing': 'Плацдарм',
  'place.rim-veil': 'Краевая вуаль',
  'place.cold-shoal': 'Холодная отмель',
  'place.dig-site': 'Раскоп',
  'place.wreck-spine': 'Хребет обломков',
  'place.flare-belt': 'Пояс вспышек',
  'place.rockfield': 'Каменное поле',
  'place.dust-reach': 'Пылевой плёс',
  'place.ore-knot': 'Рудный узел',
  'place.ion-wall': 'Ионная стена',
  'place.hollow': 'Лощина',
  'place.wreck-tail': 'Хвост обломков',
  'place.camp': 'Лагерь',
  'place.relay': 'Станция связи',
  'place.drift-moon': 'Блуждающая луна',
  'place.spore-cloud': 'Споровое облако',
  'place.scree': 'Осыпь',
  'place.deep-drift': 'Глубинный дрейф',
  'place.veil-deep': 'Глубь вуали',
  'place.biopit': 'Биояма',
  'place.brood-yard': 'Выводковый двор',
  'place.nest': 'Гнездо',
  'place.salvage-pocket': 'Трофейный карман',
  'place.bone-drift': 'Костяной дрейф',
  'place.nexus': 'Нексус',
  'place.west': 'Запад',
  'place.east': 'Восток',
  'place.home-a1': 'Бастион-1',
  'place.home-a2': 'Бастион-2',
  'place.home-b1': 'Приют-1',
  'place.home-b2': 'Приют-2',
  'place.home-green': 'Изумруд',
  'place.home-red': 'Багрянец',
