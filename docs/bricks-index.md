...
| HERO-AURA-R | ⏳ | data core | `docs/backlog.md` | Радиус ауры: начать маленьким и растить навыком |
...
| PERK-3.1 | ⏳ | core data | `docs/backlog.md` | Кто и за что выдаёт последовательные множители. |
| PERK-3.2 | 🔒 | core | `docs/backlog.md` | (PERK-3.1) Случайный промоушен: параллельный бонус становится |
