...
`C5R1` выигрывает 100%, snowball 100%, 21 позиция контента не построена ни разу. Первым
кирпичом блока **AI-BAL** бот научился исследовать (0 → 16 из 25 техов в измерении);
оборона, наземная армия, эскадрильи и герой всё ещё вне охвата — `backlog.md`, блок
AI-BAL. Отдельно: разные семьи сидов дают ИДЕНТИЧНЫЙ исход, поэтому «300 матчей» —
это 4 конфигурации по 75 повторов, а не 300 наблюдений (AI-BAL-5).
