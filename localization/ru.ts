...
export const ru: Record<string, string> = {
  ...
  'side.wing.blocked.busy': 'авианосец в бою — звеньям не до вылета',
  ...
  'side.wing.blocked.rearming.hold': 'авианосец перезаряжает звенья — вылет позже',
  ...
  'run.abandon.ask.text': 'Забег сразу закончится поражением. Награда: за волны, задачи и уничтоженных врагов.',
  ...
  'dossier.unit.bomber.desc':
    'Ударный страйкер: шаттл против КОРПУСОВ — {a} урона по кораблю, вдвое тяжелее перехватчика. По постройкам работает средне ({s} в час): мир он потреплет, но сносить его — дело осадных платформ. Тяжелее и медленнее перехватчика ({hp} корпуса, радиус {r}), дольше перезаряжается, в бой не вступает: подлетел, ударил, ушёл домой.',
  'dossier.unit.bomber.name': 'Ударный страйкер',
  'dossier.unit.heavy-striker.desc':
    'Тяжёлый ударный страйкер: {a} урона по кораблю, {s} в час по постройкам, радиус {r} — достаёт соседнюю провинцию. Медленнее ударного, {hp} корпуса, дольше перезаряжается. Открывают «Ударные векторы».',
  'dossier.unit.heavy-striker.name': 'Тяжёлый ударный страйкер',
  'dossier.unit.interceptor.desc':
    'Перехватчик: охотник за ЧУЖИМИ ШАТТЛАМИ — {s} урона по ним, больше, чем у кого-либо. По кораблям почти безвреден ({a} атаки), по постройкам тем более. Стремительный (ход {sp}), но брони нет ({hp} корпуса), радиус {r}. Главное: он поднимается САМ, без приказа, когда чужой удар проходит рядом с его портом или авианосцем, — и тратит на это топливо базы.',
  ...
  'dossier.unit.shuttle-carrier.desc':
    'Плавучий космопорт: трюм на {bay} мест под шаттлы и десант, с него шаттлы вылетают и на него садятся — значит флот бьёт шаттлами вдали от своих миров. Это КОРАБЛЬ, а не шаттл: стоит в ЗАДНЕЙ линии и держит удар ({d} защиты, {hp} корпуса), хотя своих пушек почти нет ({a} атаки). Заказывается среди кораблей. Трюм живёт ровно столько, сколько живы его корпуса: потеряете авианосец — потеряете и всё на борту.',
  'dossier.unit.shuttle-carrier.name': 'Авианосец',
  'dossier.unit.strike-carrier.desc':
    'Десантный корабль: самый большой трюм во флоте ({c} мест) на самом толстом корпусе ({hp}). Он не воюет — {a} атаки это ничто, — он довозит армию к чужому миру и держит удар, пока она высаживается. Шаттлов не несёт: ангар только у «Авианосца».',
  ...
  'sector-zero.difficulty.about.weak':
    'Обычный Рой берёт числом: флоты идут к ближайшей цели и дерутся до конца, технологий он не изучает и десант на защищённые миры не высаживает.',
  ...
  'sector-zero.prep.skills': 'Постоянное развитие навыков',
  ...
  'side.wing.garrison.hint':
    'Эскадра стоит в ангаре порта, на карте её нет. «{b}» поднимает вылет — цель выберите тапом по карте. Авианосец (◈) возит эскадру с собой: его трюм — в панели флота.',
