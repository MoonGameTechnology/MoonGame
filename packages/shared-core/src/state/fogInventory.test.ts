  ...
  return {
    ...
    battles: {
      mine_battle: {
        ...
        phase: 'orbital',
        sides: [
          { ref: { kind: 'fleet', fleetId: 'mine' }, owner: VIEWER, role: 'attacker' as const },
          { ref: { kind: 'garrison', planetId: 'A' }, owner: VIEWER, role: 'defender' as const },
        ],
        round: 1,
      },
      CANARY_battle: {
        ...
        phase: 'ground',
        sides: [
          { ref: { kind: 'landing', fleetId: 'CANARY_fleet' }, owner: RIVAL, role: 'attacker' as const },
          { ref: { kind: 'garrison', planetId: 'Z' }, owner: RIVAL, role: 'defender' as const },
        ],
        round: 7,
      },
    },
