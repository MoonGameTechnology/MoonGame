...
> **Гейт:** `pnpm run check` (lint + typecheck + test + docs-check). **Тесты: 4841 зелёный** (58 skip, 371 файл).
...
`techTree.ts` вместо `scientistModule`. **CONV-1…4 и CONV-6 закрыты** — сведены
