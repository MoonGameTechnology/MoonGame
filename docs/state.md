...
(`Dockerfile:99`, `gcr.io/distroless/nodejs22-debian13:nonroot@sha256:4e4fb0ce…`, бампнут
SEC-34 2026-09-08 — CVE не закрыл ни одной, версии пакетов те же, это гигиена пина). **`.trivyignore` держит теперь ОДНО (SEC-28):** находку, у которой
