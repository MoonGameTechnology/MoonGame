...
> **Гейт:** `pnpm run check` (lint + typecheck + test + docs-check). **Тесты: 5126 зелёных** (58 skip, 390 файлов).
...
строкой отчёта «тактика»). Вне охвата осталось то, чего ещё нет в самой игре:
