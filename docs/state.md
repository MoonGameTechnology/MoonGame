...
дают — там нужны четыре и σ. Отдельно: меряются только azure и crimson, `amber`/`violet`
не садятся в self-play ни разу (AI-BAL-12). Что осталось: территория по-прежнему
