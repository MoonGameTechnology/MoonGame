 ...
 *
 * 1. **Вместимость даёт КОРПУС** — его трюм (`cargoCapacity`, общий с десантом с SHU-5.1),
 *    и ноль читается как «не база» —
...
const data: GameData = parseGameData({
  ...
  units: {
    ...
    carrier: { faction: 'x', stats: { attack: 3, defense: 9, speed: 30, hp: 40, cargoCapacity: 2 } },
    interceptor: {
      faction: 'x',
      traits: ['shuttle'],
