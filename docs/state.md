...
## 6. Данные (`data/*.json`, версия `0.1.10`)
...
> с базовым списком `prototype/content-parity-baseline.txt` — **261 расхождение** (замер
> 2026-08-27 дал 274; CONV-15 закрыл 13 из них — ниже). Красное в ОБЕ стороны: новая
