...
pnpm run selfplay 300 base   # батч AI-vs-AI на реальном ядре (баланс)
...
0 → 2250 за 300 матчей, захватов штурмом 0 → 1500, мёртвого контента 21 → 15 позиций;
отдельными строками отчёта теперь видно вторую фазу захвата — «прилётом / штурмом»).
Вне охвата остаются оборона (`fort`/`starfort`/`orbital_aa`), эскадрильи, носители и
герой — `backlog.md`, блок AI-BAL. Не сдвинулись ни одним кирпичом и живут не в
расширении бота: старт `C5R1` 100% и snowball 100%. Отдельно: разные семьи сидов дают
