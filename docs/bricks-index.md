...
| AUD-1 | ✅ | cli | `docs/backlog.md:12494` | клиент собирал 11 фрагментов из 18. |
| AUD-2 | ✅ | srv core | `docs/backlog.md:12514` | фог-роутинг событий не покрыт тестом. |
| AUD-11 | ✅ | core | `docs/backlog.md:12543` | effect.applied всегда называет адресата. |
| AUD-15 | ✅ | srv | `docs/backlog.md:12575` | сканер фог-контракта больше не слеп к комментариям. |
| AUD-3 | ✅ | data | `docs/backlog.md:12598` | 28 непереводимых имён игровых данных вычищены. |
| AUD-4 | ✅ | proto | `docs/backlog.md:12629` | гейт локализации увидел шипнутый контент. |
| AUD-14 | ✅ | proto | `docs/backlog.md:12661` | имена домов доезжают до игрока переводом. |
| AUD-12 | ✅ | proto | `docs/backlog.md:12683` | шапка досье героя больше не показывает игроку сам ключ. |
| AUD-13 | ✅ | core proto | `docs/backlog.md:12699` | hero.name — отображаемый текст, вшитый в |
| AUD-5 | ✅ | core | `docs/backlog.md:12743` | экспортирован runUntil(kernel, state, ctx, opts?). |
| AUD-6 | ✅ | core | `docs/backlog.md:12758` | actionPayloadSchemas и CLIENTACTIONTYPES публичны. |
| AUD-7 | ✅ | proto | `docs/backlog.md:12766` | SELFPLAYJSON отдаёт всё, что печатает человеку. |
| AUD-8 | 🗑 | proto | `docs/backlog.md:12774` | сведён в CONV-12 |
| AUD-9 | ✅ | sec | `docs/backlog.md:12782` | merge-queue выбрасывал PR с CIFAILURE при зелёном коде. |
| AUD-10 | ✅ | sec | `docs/backlog.md:12810` | зелёный PR не вставал в очередь: у автомержа один шанс, и он |
...
| RESIL-1 | ⏳ | proto | `docs/backlog.md:13087` | Фоновые промисы браузерного клиента. |
| RESIL-2 | ⏳ | proto | `docs/backlog.md:13098` | Цикл подсветки обучающего тура. |
| RESIL-3 | ⏳ | srv | `docs/backlog.md:13106` | Именованный фатал процесса. |
| RESIL-4 | ✅ | srv | `docs/backlog.md:13117` | Соак проверяет, что мир не встал. |
| RESIL-5 | ✅ | srv proto | `docs/backlog.md:13135` | Генеральная репетиция: весь стек разом, и |
| RESIL-6 | ✅ | srv proto | `docs/backlog.md:13170` | Достоверность генералки: настоящая база, |
| ADDR-7 | ✅ | sec proto | `docs/backlog.md:13312` | Ссылка на партию не пускает по незнанию: |
| OPS-2 | ✅ | ops sec | `docs/backlog.md:13350` | Обновление доносит до машины новые ключи |
| REL-6 | ✅ | srv | `docs/backlog.md:13372` | Возврат на своё место мгновенный: перехват вместо |
| CMB-4 | ✅ | core | `docs/backlog.md:13387` | Первый раунд боя — на самой встрече, а не через |
| BLD-1 | ✅ | core proto | `docs/backlog.md:13407` | Очередь строительства: заказы встают в |
...
| CMB-7 | ✅ | core | `docs/backlog.md:13581` | Перемирие посреди боя не останавливало бой. |
| RLY-1 | ✅ | proto | `docs/backlog.md:13602` | Сбор построенного: соло и сеть играли по РАЗНЫМ |
| CARGO-1 | ✅ | core proto | `docs/backlog.md:13634` | Часовая погрузка десанта жила в |
| MRG-1 | ✅ | core proto | `docs/backlog.md:13682` | «Слиться по прибытии» — вторая половина |
| ART-0 | ✅ | core data proto | `docs/backlog.md:13705` | Артиллерия снята из игры целиком |
| ORB-1 | ✅ | core data proto | `docs/backlog.md:13736` | Орбитальный слой объявлен в |
| ORB-2 | ✅ | data proto | `docs/backlog.md:13768` | «Изучается технология, строится здание» не |
| ORB-3 | ✅ | proto | `docs/backlog.md:13796` | Звёздный форт выдавал орбитальное ПКО мимо |
| CMB-6 | ✅ | core | `docs/backlog.md:13833` | После ничьей третий враждебный флот получает свой |
| ORD-2 | ✅ | proto | `docs/backlog.md:13863` | Нацеленный ШТУРМ теперь переживает закрытую |
| FOG-10 | ✅ | proto core | `docs/backlog.md:13883` | Память разведки перестала жить только |
| FOG-9 | ✅ | core | `docs/backlog.md:13907` | Приостановленная стройка чужого мира была видна |
| TEST-4 | ✅ | srv | `docs/backlog.md:13917` | topXp падал на живой базе разработчика. |
...
| MSB-0 | ⏳ | docs | `docs/multiside-combat-roadmap.md:99` | Решение владельца: (а), (б) или (в) |
| MSB-1 | ⏳ | core | `docs/multiside-combat-roadmap.md:108` | Battle становится СПИСКОМ сторон |
| MSB-2 | ⏳ | core data | `docs/multiside-combat-roadmap.md:123` | Правило деления урона |
| MSB-3 | ⏳ | core | `docs/multiside-combat-roadmap.md:141` | Вступление в идущий бой |
| MSB-4 | ⏳ | core | `docs/multiside-combat-roadmap.md:155` | Совместный штурм и чей мир |
| MSB-5 | ⏳ | core | `docs/multiside-combat-roadmap.md:168` | Что делает бой при смене владельца стороны |
| MSB-6 | ⏳ | proto cli | `docs/multiside-combat-roadmap.md:177` | Панель боя на N сторон |
| MSB-7 | ⏳ | core proto | `docs/multiside-combat-roadmap.md:185` | Зенитки, обстрел и артиллерия при N сторонах |
...
| SHU-4.1 | ✅ | proto | `docs/shuttles-roadmap.md:351` | Словарь: эскадра у мира, флот у кораблей 2026-09-10 |
| SHU-4.2 | ✅ | core data | `docs/shuttles-roadmap.md:393` | Эскадра как соединение ангара 2026-09-10 |
| SHU-4.3 | ✅ | proto | `docs/shuttles-roadmap.md:453` | Панель мира: эскадры как флоты 2026-09-10 |
| SHU-4.4 | ⏳ | core | `docs/shuttles-roadmap.md:505` | Погоня: удар по движущейся цели |
