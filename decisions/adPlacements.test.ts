...
describe('YAG-3.2 — места rewarded-рекламы', () => {
  it('мест ровно четыре — резолюция владельца §0.6а, и у каждого свой постоянный id', () => {
    // Двойная награда, Суверены, обновление витрины, покупка лота. Пятое место — это
    // решение владельца, а не строчка кода: список закрыт намеренно.
