...
export const ru: Record<string, string> = {
  ...
  'hud.goal.pve': 'Задача: пережить {n} волн и лишить Рой всех владений. Пиратская база — необязательный первый бой.',
  ...
  'sector-zero.signin.why': 'Сейв в облаке и игра с других устройств.',
