...
Статус на 12 сентября: **компактное окно у флота, пинг в тумане и непрерывная
кромка проверены в Chromium**. Исправления основаны на влитом PR #973
(`main`, `d5b4e1a5`). Текущие результаты — в последней секции; проверки
...
idle 0,82 мс, pan 4,99 мс, zoom 3,80 мс; этот замер не оценивает GPU устройства.
