...
export const ru: Record<string, string> = {
  ...
  'onb.tour.first.troops':
    'У флота есть трюм для десанта: тапни его на своём мире → «Наземная армия ⇄ гарнизон» → «Погрузить». Открытый мир берёшь одной орбитой, а мир с гарнизоном — только высадкой: сначала флот собьёт оборону сверху, потом десант берёт землю.',
