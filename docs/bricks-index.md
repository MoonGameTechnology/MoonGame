...
| PHONE-STRATEGY | ✅ |  | `docs/backlog.md:14914` | Технологии, постройки, производство, рынок и дипломатия |
| MAP-PERF | ✅ |  | `docs/backlog.md:14926` | Ускорение движения раскрытой голографической карты и подготовка |
...
| PVR-1.1 | ⏳ | proto | `docs/sector-zero-roadmap.md:887` | Соло-запуск задаёт modeId |
| PVR-1.2 | 🔒 | proto | `docs/sector-zero-roadmap.md:894` | HUD забега: волна N из M и время до следующей |
| PVR-1.3 | 🔒 | data | `docs/sector-zero-roadmap.md:900` | Состав волны перестаёт быть одним дроном |
| PVR-1.4 | 🔒 | proto | `docs/sector-zero-roadmap.md:908` | Выбор между волнами |
| PVR-2.1 | ⏳ | proto | `docs/sector-zero-roadmap.md:919` | Выбор сложности на запуске забега |
| PVR-3.1 | ⏳ | docs | `docs/sector-zero-roadmap.md:930` | Резолюция: чем PvE-прокачка НЕ является |
| PVR-3.2 | 🔒 | proto | `docs/sector-zero-roadmap.md:938` | Хранилище PvE-прогресса |
| PVR-3.3 | 🔒 | proto | `docs/sector-zero-roadmap.md:945` | Награда за забег |
| PVR-4.1 | ⏳ | docs | `docs/sector-zero-roadmap.md:959` | Резолюция: что из §3 входит в первую версию |
| PVR-4.2 | 🔒 | core | `docs/sector-zero-roadmap.md:967` | Память Роя как состояние |
| PVR-4.3 | 🔒 | core data | `docs/sector-zero-roadmap.md:976` | Одна читаемая адаптация от сигнала до формы |
| PVR-4.4 | 🔒 | data | `docs/sector-zero-roadmap.md:984` | Структуры первого набора |
| PVR-4.5 | 🔒 | proto | `docs/sector-zero-roadmap.md:990` | Журнал адаптаций |
