...
(0 → 16 из 25 техов в измерении), AI-BAL-3 — наземная армия и десант (наземных боёв
...
выстрела; snowball 91–92%; кредиты копятся до 64k при нулевых arrears; дерево технологий
работает как очередь по цене. **Причина «нулевых arrears» найдена и снята (BAL-3):**
